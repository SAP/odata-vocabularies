...
[CreateHidden](UI.xml#L1321) *(Experimental)*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/master/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="CreateHidden"></a>Determines visibility of New button<p>The annotation value should be a (path) expression to dynamically hide or render the New button</p>
[UpdateHidden](UI.xml#L1329) *(Experimental)*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/master/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="UpdateHidden"></a>Determines visibility of Edit and Save buttons<p>The annotation value should be a (path) expression to dynamically hide or render the Edit and Save buttons</p>
[DeleteHidden](UI.xml#L1337) *(Experimental)*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/master/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="DeleteHidden"></a>Determines visibility of Delete button<p>The annotation value should be a (path) expression to dynamically hide or render the Delete button</p>
[DataFieldDefault](UI.xml#L1345) *(Experimental)*|[DataFieldAbstract](#DataFieldAbstract)|<a name="DataFieldDefault"></a>Default representation of a property as a datafield, e.g. when the property is added as a table column or form field via personalization<p>Only concrete subtypes of DataFieldAbstract can be used for a DataFieldDefault. For type [DataField](#DataField) and its subtypes the annotation target SHOULD be the same property that is referenced via a path expression in the `Value` of the datafield.</p>
[Criticality](UI.xml#L1526)|[CriticalityType](#CriticalityType)|<a name="Criticality"></a>Service-calculated criticality, alternative to UI.CriticalityCalculation
[CriticalityCalculation](UI.xml#L1530)|[CriticalityCalculationType](#CriticalityCalculationType)|<a name="CriticalityCalculation"></a>Parameters for client-calculated criticality, alternative to UI.Criticality
[OrderBy](UI.xml#L1534) *(Experimental)*|PropertyPath|<a name="OrderBy"></a>Sort by the referenced property instead of by the annotated property<p>Example: annotated property `SizeCode` has string values XS, S, M, L, XL, referenced property SizeOrder has numeric values -2, -1, 0, 1, 2. Numeric ordering by SizeOrder will be more understandable than lexicographic ordering by SizeCode.</p>
[RecommendationState](UI.xml#L1542) *(Experimental)*|[RecommendationStateType](#RecommendationStateType)|<a name="RecommendationState"></a>Indicates whether a field contains or has a recommended value<p>Intelligent systems can help users by recommending input the user may "prefer".</p>
[RecommendationList](UI.xml#L1574) *(Experimental)*|[RecommendationListType](#RecommendationListType)|<a name="RecommendationList"></a>Specifies how to get a list of recommended values for a property or parameter<p>Intelligent systems can help users by recommending input the user may "prefer".</p>
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1362)|String|A short, human-readable text suitable for labels and captions in UIs
[Criticality](UI.xml#L1366)|[CriticalityType](#CriticalityType)|Criticality of the data field value
[CriticalityRepresentation](UI.xml#L1369)|[CriticalityRepresentationType](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[IconUrl](UI.xml#L1372)|URL|Optional icon

## <a name="CriticalityRepresentationType"></a>[CriticalityRepresentationType](UI.xml#L1378)


Member|Value|Description
:-----|----:|:----------
[WithIcon](UI.xml#L1379)|0|Criticality is represented with an icon
[WithoutIcon](UI.xml#L1382)|1|Criticality is represented without icon, e.g. only via text color

## <a name="DataFieldForAnnotation"></a>[DataFieldForAnnotation](UI.xml#L1387): [DataFieldAbstract](#DataFieldAbstract)
...
[*CriticalityRepresentation*](UI.xml#L1369)|[CriticalityRepresentationType](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[Target](UI.xml#L1389)|AnnotationPath|Target MUST reference an annotation of terms Communication.Contact, Communication.Address, UI.DataPoint, UI.Chart, UI.FieldGroup, or UI.ConnectedFields

## <a name="DataFieldForActionAbstract"></a>[*DataFieldForActionAbstract*](UI.xml#L1405): [DataFieldAbstract](#DataFieldAbstract)
Triggers an action
...
[*CriticalityRepresentation*](UI.xml#L1369)|[CriticalityRepresentationType](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[Inline](UI.xml#L1407)|Boolean|Action should be placed close to (or even inside) the visualized term
[Determining](UI.xml#L1410)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
...
[*Inline*](UI.xml#L1407)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1410)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[Action](UI.xml#L1420)|[QualifiedName](Common.md#QualifiedName)|Qualified name of an Action, Function, ActionImport or FunctionImport in scope
[InvocationGrouping](UI.xml#L1424)|[OperationGroupingType](#OperationGroupingType)|Expresses how invocations of this action on multiple instances should be grouped

## <a name="OperationGroupingType"></a>[OperationGroupingType](UI.xml#L1429)


Member|Value|Description
:-----|----:|:----------
[Isolated](UI.xml#L1430)|0|Invoke each action in isolation from other actions
[ChangeSet](UI.xml#L1433)|1|Group all actions into a single change set
...
[*CriticalityRepresentation*](UI.xml#L1369)|[CriticalityRepresentationType](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[Value](UI.xml#L1470)|PrimitiveType|The data field's value

## <a name="DataFieldWithAction"></a>[DataFieldWithAction](UI.xml#L1476): [DataField](#DataField)
...
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[*Value*](UI.xml#L1470)|PrimitiveType|The data field's value
[Action](UI.xml#L1480)|[QualifiedName](Common.md#QualifiedName)|Qualified name of an Action, Function, ActionImport or FunctionImport in scope

## <a name="DataFieldWithIntentBasedNavigation"></a>[DataFieldWithIntentBasedNavigation](UI.xml#L1486): [DataField](#DataField)
...
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[*Value*](UI.xml#L1470)|PrimitiveType|The data field's value
[SemanticObject](UI.xml#L1494)|String|Name of the Semantic Object
[Action](UI.xml#L1497)|String|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.

## <a name="DataFieldWithNavigationPath"></a>[DataFieldWithNavigationPath](UI.xml#L1503): [DataField](#DataField)
...
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[*Value*](UI.xml#L1470)|PrimitiveType|The data field's value
[Target](UI.xml#L1506)|NavigationPropertyPath|Contains either a navigation property or a term cast, where term is of type Edm.EntityType or a concrete entity type or a collection of these types

## <a name="DataFieldWithUrl"></a>[DataFieldWithUrl](UI.xml#L1513): [DataField](#DataField)
...
[*IconUrl*](UI.xml#L1372)|URL|Optional icon
[*Value*](UI.xml#L1470)|PrimitiveType|The data field's value
[Url](UI.xml#L1516)|URL|Target of the hyperlink
[UrlContentType](UI.xml#L1520)|MediaType|Media type of the hyperlink target, e.g. `video/mp4`

## <a name="RecommendationStateType"></a>[RecommendationStateType](UI.xml#L1550) *(Experimental)*
**Type:** Byte
...
## <a name="RecommendationListType"></a>[RecommendationListType](UI.xml#L1583) *(Experimental)*
...
Property|Type|Description
:-------|:---|:----------
[CollectionPath](UI.xml#L1589)|String|Resource path of a collection of recommended values
[RankProperty](UI.xml#L1592)|String|Name of the property within the collection of recommended values that describes the rank of the recommendation
...
## <a name="RecommendationBinding"></a>[RecommendationBinding](UI.xml#L1601) *(Experimental)*


Property|Type|Description
:-------|:---|:----------
[LocalDataProperty](UI.xml#L1603)|PropertyPath|Path to editable property for which recommended values exist
[ValueListProperty](UI.xml#L1606)|String|Path to property in the collection of recommended values. Format is identical to PropertyPath annotations.
