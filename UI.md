...
[ConnectedFields](UI.xml#L130) *(Experimental)*|[ConnectedFieldsType](#ConnectedFieldsType)|<a name="ConnectedFields"></a>Group of semantically connected fields with a representation template and an optional label ([Example](UI.xml#L134))
[GeoLocations](UI.xml#L201)|\[[GeoLocationType](#GeoLocationType)\]|<a name="GeoLocations"></a>Collection of geographic locations
[GeoLocation](UI.xml#L205)|[GeoLocationType](#GeoLocationType)|<a name="GeoLocation"></a>Geographic location
[Contacts](UI.xml#L225)|\[AnnotationPath\]|<a name="Contacts"></a>Collection of contacts<p>Each collection item MUST reference an annotation of a Communication.Contact</p>
[MediaResource](UI.xml#L232)|[MediaResourceType](#MediaResourceType)|<a name="MediaResource"></a>Properties that describe a media resource
[DataPoint](UI.xml#L286)|[DataPointType](#DataPointType)|<a name="DataPoint"></a>Visualization of a single point of data, typically a number; may also be textual, e.g. a status value
[KPI](UI.xml#L578)|[KPIType](#KPIType)|<a name="KPI"></a>A Key Performance Indicator (KPI) bundles a SelectionVariant and a DataPoint, and provides details for progressive disclosure
[Chart](UI.xml#L627)|[ChartDefinitionType](#ChartDefinitionType)|<a name="Chart"></a>Visualization of multiple data points
...
## <a name="ConnectedFieldsType"></a>[ConnectedFieldsType](UI.xml#L159) *(Experimental)*
Group of semantically connected fields with a representation template and an optional label

Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L163)|String|Label for the connected fields
[Template](UI.xml#L167)|String|Template for representing the connected fields<p>Template variables are identifiers enclosed in curly braces, e.g. `{MaterialName} - {MaterialClassName}`. The `Data` collection assigns values to the template variables.</p>
[Data](UI.xml#L173)|[Dictionary](https://github.com/oasis-tcs/odata-vocabularies/blob/master/vocabularies/Org.OData.Core.V1.md#Dictionary)|Dictionary of template variables<p>Each template variable used in `Template` must be assigned a value here. The value must be of type [`UI.DataFieldAbstract`](#DataFieldAbstract)</p>

## <a name="GeoLocationType"></a>[GeoLocationType](UI.xml#L209)
Properties that define a geographic location

Property|Type|Description
:-------|:---|:----------
[Latitude](UI.xml#L211)|Double|Geographic latitude
[Longitude](UI.xml#L214)|Double|Geographic longitude
[Location](UI.xml#L217)|GeographyPoint|A point in a round-earth coordinate system
[Address](UI.xml#L220)|[AddressType](Communication.md#AddressType)|vCard-style address

## <a name="MediaResourceType"></a>[MediaResourceType](UI.xml#L236)


Property|Type|Description
:-------|:---|:----------
[Url](UI.xml#L237)|URL|URL of media resource
[ContentType](UI.xml#L241)|MediaType|Content type, such as application/pdf, video/x-flv, image/jpeg
[ByteSize](UI.xml#L245)|Int64|Resource size in bytes
[ChangedAt](UI.xml#L248)|DateTimeOffset|Date of last change
[Thumbnail](UI.xml#L251)|[ImageType](#ImageType)|Thumbnail image
[Title](UI.xml#L254)|[DataField](#DataField)|Resource title
[Description](UI.xml#L257)|[DataField](#DataField)|Resource description

## <a name="ImageType"></a>[ImageType](UI.xml#L261)


Property|Type|Description
:-------|:---|:----------
[Url](UI.xml#L262)|URL|URL of image
[Width](UI.xml#L266)|String|Width of image
[Height](UI.xml#L269)|String|Height of image

## <a name="DataPointType"></a>[DataPointType](UI.xml#L291)


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L292)|String|Title of the data point
[Description](UI.xml#L296)|String|Short description
[LongDescription](UI.xml#L300)|String|Full description
[Value](UI.xml#L304)|PrimitiveType|Numeric value<p> The value is typically provided via a `Path` construct. The path MUST lead to a direct property of the same entity type or a property of a complex property (recursively) of that entity type, navigation segments are not allowed.<br/>It could be annotated with either `UoM.ISOCurrency` or `UoM.Unit`. Percentage values are annotated with `UoM.Unit = '%'`. A renderer should take an optional `Common.Text` annotation into consideration.             </p>
[TargetValue](UI.xml#L316)|PrimitiveType|Target value
[ForecastValue](UI.xml#L319)|PrimitiveType|Forecast value
[MinimumValue](UI.xml#L322)|Decimal|Minimum value (for output rendering)
[MaximumValue](UI.xml#L325)|Decimal|Maximum value (for output rendering)
[ValueFormat](UI.xml#L328)|[NumberFormat](#NumberFormat)|Number format
[Visualization](UI.xml#L331)|[VisualizationType](#VisualizationType)|Preferred visualization
[SampleSize](UI.xml#L334)|PrimitiveType|Sample size used for the determination of the data point; should contain just integer value as Edm.Byte, Edm.SByte, Edm.Intxx, and Edm.Decimal with scale 0.
[ReferencePeriod](UI.xml#L341)|[ReferencePeriod](#ReferencePeriod)|Reference period
[Criticality](UI.xml#L344)|[CriticalityType](#CriticalityType)|Service-calculated criticality, alternative to CriticalityCalculation
[CriticalityRepresentation](UI.xml#L347) *(Experimental)*|[CriticalityRepresentationType](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[CriticalityCalculation](UI.xml#L351)|[CriticalityCalculationType](#CriticalityCalculationType)|Parameters for client-calculated criticality, alternative to Criticality
[Trend](UI.xml#L354)|[TrendType](#TrendType)|Service-calculated trend, alternative to TrendCalculation
[TrendCalculation](UI.xml#L357)|[TrendCalculationType](#TrendCalculationType)|Parameters for client-calculated trend, alternative to Trend
[Responsible](UI.xml#L360)|[ContactType](Communication.md#ContactType)|Contact person

## <a name="NumberFormat"></a>[NumberFormat](UI.xml#L365)
Describes how to visualise a number

Property|Type|Description
:-------|:---|:----------
[ScaleFactor](UI.xml#L367)|Decimal|Display value in *ScaleFactor* units, e.g. 1000 for k (kilo), 1e6 for M (Mega)
[NumberOfFractionalDigits](UI.xml#L371)|Byte|Number of fractional digits of the scaled value to be visualized

## <a name="VisualizationType"></a>[VisualizationType](UI.xml#L376)


Member|Value|Description
:-----|----:|:----------
[Number](UI.xml#L377)|0|Visualize as a number
[BulletChart](UI.xml#L380)|1|Visualize as bullet chart - requires TargetValue
[Progress](UI.xml#L383)|2|Visualize as progress indicator - requires TargetValue
[Rating](UI.xml#L386)|3|Visualize as partially or completely filled stars/hearts/... - requires TargetValue
[Donut](UI.xml#L390)|4|Visualize as donut, optionally with missing segment - requires TargetValue
[DeltaBulletChart](UI.xml#L393)|5|Visualize as delta bullet chart - requires TargetValue

## <a name="ReferencePeriod"></a>[ReferencePeriod](UI.xml#L398)
Reference period

Property|Type|Description
:-------|:---|:----------
[Description](UI.xml#L400)|String|Short description of the reference period
[Start](UI.xml#L404)|DateTimeOffset|Start of the reference period
[End](UI.xml#L407)|DateTimeOffset|End of the reference period

## <a name="CriticalityType"></a>[CriticalityType](UI.xml#L412)
Criticality of a value or status, represented e.g. via semantic colors (https://experience.sap.com/fiori-design-web/foundation/colors/#semantic-colors)

Member|Value|Description
:-----|----:|:----------
[VeryNegative](UI.xml#L415) *(Experimental)*|-1|Very negative / dark-red status - risk - out of stock - late
[Neutral](UI.xml#L419)|0|Neutral / grey status - inactive - open - in progress
[Negative](UI.xml#L422)|1|Negative / red status - attention - overload - alert
[Critical](UI.xml#L425)|2|Critical / orange status - warning
[Positive](UI.xml#L428)|3|Positive / green status - completed - available - on track - acceptable
[VeryPositive](UI.xml#L431) *(Experimental)*|4|Very positive / blue status - above max stock - excess

## <a name="CriticalityCalculationType"></a>[CriticalityCalculationType](UI.xml#L437): [CriticalityThresholdsType](#CriticalityThresholdsType)
...
Property|Type|Description
:-------|:---|:----------
[*AcceptanceRangeLowValue*](UI.xml#L482)|PrimitiveType|Lowest value that is considered positive
[*AcceptanceRangeHighValue*](UI.xml#L485)|PrimitiveType|Highest value that is considered positive
[*ToleranceRangeLowValue*](UI.xml#L488)|PrimitiveType|Lowest value that is considered neutral
[*ToleranceRangeHighValue*](UI.xml#L491)|PrimitiveType|Highest value that is considered neutral
[*DeviationRangeLowValue*](UI.xml#L494)|PrimitiveType|Lowest value that is considered critical
[*DeviationRangeHighValue*](UI.xml#L497)|PrimitiveType|Highest value that is considered critical
[ImprovementDirection](UI.xml#L468)|[ImprovementDirectionType](#ImprovementDirectionType)|Describes in which direction the value improves
[ConstantThresholds](UI.xml#L471) *(Experimental)*|\[[LevelThresholdsType](#LevelThresholdsType)\]|List of thresholds depending on the aggregation level as a set of constant values<p>Constant thresholds shall only be used in order to refine constant values given for the data point overall (aggregation level with empty collection of property paths), but not if the thresholds are based on other measure elements.</p>

## <a name="CriticalityThresholdsType"></a>[CriticalityThresholdsType](UI.xml#L480)
...
## <a name="ImprovementDirectionType"></a>[ImprovementDirectionType](UI.xml#L502)
Describes which direction of a value change is seen as an improvement

Member|Value|Description
:-----|----:|:----------
[Minimize](UI.xml#L504)|1|Lower is better
[Target](UI.xml#L507)|2|Closer to the target is better
[Maximize](UI.xml#L510)|3|Higher is better

## <a name="LevelThresholdsType"></a>[LevelThresholdsType](UI.xml#L515): [CriticalityThresholdsType](#CriticalityThresholdsType) *(Experimental)*
...
[*DeviationRangeLowValue*](UI.xml#L494)|PrimitiveType|Lowest value that is considered critical
[*DeviationRangeHighValue*](UI.xml#L497)|PrimitiveType|Highest value that is considered critical
[AggregationLevel](UI.xml#L518)|\[PropertyPath\]|An unordered tuple of dimensions, i.e. properties which are intended to be used for grouping in aggregating requests. In analytical UIs, e.g. an analytical chart, the aggregation level typically corresponds to the visible dimensions.

## <a name="TrendType"></a>[TrendType](UI.xml#L524)
The trend of a value

Member|Value|Description
:-----|----:|:----------
[StrongUp](UI.xml#L526)|1|Value grows strongly
[Up](UI.xml#L529)|2|Value grows
[Sideways](UI.xml#L532)|3|Value does not significantly grow or shrink
[Down](UI.xml#L535)|4|Value shrinks
[StrongDown](UI.xml#L538)|5|Value shrinks strongly

## <a name="TrendCalculationType"></a>[TrendCalculationType](UI.xml#L543)
...
Property|Type|Description
:-------|:---|:----------
[ReferenceValue](UI.xml#L557)|PrimitiveType|Reference value for the calculation, e.g. number of sales for the last year
[IsRelativeDifference](UI.xml#L561)|Boolean|Calculate with a relative difference
[UpDifference](UI.xml#L564)|Decimal|Threshold for Up
[StrongUpDifference](UI.xml#L567)|Decimal|Threshold for StrongUp
[DownDifference](UI.xml#L570)|Decimal|Threshold for Down
[StrongDownDifference](UI.xml#L573)|Decimal|Threshold for StrongDown

## <a name="KPIType"></a>[KPIType](UI.xml#L584)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L585)|String|Optional identifier to reference this instance from an external context
[ShortDescription](UI.xml#L590) *(Experimental)*|String|Very short description
[SelectionVariant](UI.xml#L595)|[SelectionVariantType](#SelectionVariantType)|Selection variant, either specified inline or referencing another annotation via Path
[DataPoint](UI.xml#L599)|[DataPointType](#DataPointType)|Data point, either specified inline or referencing another annotation via Path
[Detail](UI.xml#L603)|[KPIDetailType](#KPIDetailType)|Contains information about KPI details, especially drill-down presentations

## <a name="KPIDetailType"></a>[KPIDetailType](UI.xml#L608)


Property|Type|Description
:-------|:---|:----------
[DefaultPresentationVariant](UI.xml#L609)|[PresentationVariantType](#PresentationVariantType)|Presentation variant, either specified inline or referencing another annotation via Path
[AlternativePresentationVariants](UI.xml#L613)|\[[PresentationVariantType](#PresentationVariantType)\]|A list of alternative presentation variants, either specified inline or referencing another annotation via Path
[SemanticObject](UI.xml#L617)|String|Name of the Semantic Object. If not specified, use Semantic Object annotated at the property referenced in KPI/DataPoint/Value
[Action](UI.xml#L621)|String|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.

## <a name="ChartDefinitionType"></a>[ChartDefinitionType](UI.xml#L631)


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L632)|String|Title of the chart
[Description](UI.xml#L636)|String|Short description
[ChartType](UI.xml#L640)|[ChartType](#ChartType)|Chart type
[AxisScaling](UI.xml#L643)|[ChartAxisScalingType](#ChartAxisScalingType)|Describes the scale of the chart value axes
[Measures](UI.xml#L646)|\[PropertyPath\]|Measures of the chart, e.g. size and color in a bubble chart
[MeasureAttributes](UI.xml#L649)|\[[ChartMeasureAttributeType](#ChartMeasureAttributeType)\]|Describes Attributes for Measures. All Measures used in this collection must also be part of the Measures Property.
[Dimensions](UI.xml#L654)|\[PropertyPath\]|Dimensions of the chart, e.g. x- and y-axis of a bubble chart
[DimensionAttributes](UI.xml#L657)|\[[ChartDimensionAttributeType](#ChartDimensionAttributeType)\]|Describes Attributes for Dimensions. All Dimensions used in this collection must also be part of the Dimensions Property.
[Actions](UI.xml#L662)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Available actions

## <a name="ChartType"></a>[ChartType](UI.xml#L667)


Member|Value|Description
:-----|----:|:----------
[Column](UI.xml#L668)|0|
[ColumnStacked](UI.xml#L669)|1|
[ColumnDual](UI.xml#L670)|2|
[ColumnStackedDual](UI.xml#L671)|3|
[ColumnStacked100](UI.xml#L672)|4|
[ColumnStackedDual100](UI.xml#L673)|5|
[Bar](UI.xml#L674)|6|
[BarStacked](UI.xml#L675)|7|
[BarDual](UI.xml#L676)|8|
[BarStackedDual](UI.xml#L677)|9|
[BarStacked100](UI.xml#L678)|10|
[BarStackedDual100](UI.xml#L679)|11|
[Area](UI.xml#L680)|12|
[AreaStacked](UI.xml#L681)|13|
[AreaStacked100](UI.xml#L682)|14|
[HorizontalArea](UI.xml#L683)|15|
[HorizontalAreaStacked](UI.xml#L684)|16|
[HorizontalAreaStacked100](UI.xml#L685)|17|
[Line](UI.xml#L686)|18|
[LineDual](UI.xml#L687)|19|
[Combination](UI.xml#L688)|20|
[CombinationStacked](UI.xml#L689)|21|
[CombinationDual](UI.xml#L690)|22|
[CombinationStackedDual](UI.xml#L691)|23|
[HorizontalCombinationStacked](UI.xml#L692)|24|
[Pie](UI.xml#L693)|25|
[Donut](UI.xml#L694)|26|
[Scatter](UI.xml#L695)|27|
[Bubble](UI.xml#L696)|28|
[Radar](UI.xml#L697)|29|
[HeatMap](UI.xml#L698)|30|
[TreeMap](UI.xml#L699)|31|
[Waterfall](UI.xml#L700)|32|
[Bullet](UI.xml#L701)|33|
[VerticalBullet](UI.xml#L702)|34|
[HorizontalWaterfall](UI.xml#L703)|35|
[HorizontalCombinationDual](UI.xml#L704)|36|
[HorizontalCombinationStackedDual](UI.xml#L705)|37|
[Donut100](UI.xml#L706) *(Experimental)*|38|
...
Property|Type|Description
:-------|:---|:----------
[Value](UI.xml#L840)|PrimitiveType|MUST be a fixed value of primitive type
