...
:------------|:----------
[DataSubject](PersonalData.xml#L79) *(Experimental)*|The entities of this set describe a data subject (an identified or identifiable natural person), e.g. Customer, Vendor<p>These entities are relevant for audit logging. There are no restrictions on their structure. The properties should be annotated suitably with [FieldSemantics](#FieldSemantics).</p>
[DataSubjectDetails](PersonalData.xml#L89) *(Experimental)*|The entities of this set contain details to a data subject (an identified or identifiable natural person) but do not by themselves identify/describe a data subject, e.g. CustomerAddress<p>These entities are relevant for audit logging. There are no restrictions on their structure. The properties should be annotated suitably with [FieldSemantics](#FieldSemantics).</p>
...
Allowed Value|Description
:------------|:----------
[DataSubjectID](PersonalData.xml#L153) *(Experimental)*|The unique identifier for a data subject
[DataSubjectIDType](PersonalData.xml#L158) *(Experimental)*|The type of ID identifying the data subject and which is allocated when creating a consent record, e.g. an e-mail address or a phone number.
