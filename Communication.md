...
:---|:---|:----------
[Contact](Communication.xml#L37)|[ContactType](#ContactType)|<a name="Contact"></a>Address book entry
[Address](Communication.xml#L121)|[AddressType](#AddressType)|<a name="Address"></a>Address
...
## <a name="ContactType"></a>[ContactType](Communication.xml#L40)


Property|Type|Description
:-------|:---|:----------
[fn](Communication.xml#L41)|String|Full name
[n](Communication.xml#L44)|[NameType](#NameType)|Name
[nickname](Communication.xml#L47)|String|Nickname
[photo](Communication.xml#L50)|URL|Image or photograph
[bday](Communication.xml#L54)|Date|Birthday
[anniversary](Communication.xml#L57)|Date|Date of marriage, or equivalent
[gender](Communication.xml#L60)|[GenderType](#GenderType)|Sex and gender identity
[title](Communication.xml#L64)|String|Position or job title
[role](Communication.xml#L67)|String|Function or part played in a particular situation
[org](Communication.xml#L70)|String|Organization Name defined by X.520
[orgunit](Communication.xml#L73)|String|Organization Unit defined by X.520
[kind](Communication.xml#L77)|[KindType](#KindType)|Kind of contact
[note](Communication.xml#L81)|String|Supplemental information or a comment associated with the contact
[adr](Communication.xml#L85)|\[[AddressType](#AddressType)\]|Addresses
[tel](Communication.xml#L88)|\[[PhoneNumberType](#PhoneNumberType)\]|Phone numbers
[email](Communication.xml#L91)|\[[EmailAddressType](#EmailAddressType)\]|Email addresses
[geo](Communication.xml#L94)|\[[GeoDataType](#GeoDataType)\]|Geographic locations
[url](Communication.xml#L97)|\[[UrlType](#UrlType)\]|URLs

## <a name="NameType"></a>[NameType](Communication.xml#L103)


Property|Type|Description
:-------|:---|:----------
[surname](Communication.xml#L104)|String|Surname or family name
[given](Communication.xml#L107)|String|Given name
[additional](Communication.xml#L110)|String|Additional names
[prefix](Communication.xml#L113)|String|Honorific prefix(es)
[suffix](Communication.xml#L116)|String|Honorific suffix(es)

## <a name="AddressType"></a>[AddressType](Communication.xml#L124)


Property|Type|Description
:-------|:---|:----------
[building](Communication.xml#L125)|String|Building identifier
[street](Communication.xml#L128)|String|Street address
[district](Communication.xml#L131)|String|Territorial administrative organization in a large city
[locality](Communication.xml#L134)|String|City or similar
[region](Communication.xml#L137)|String|State, province, or similar
[code](Communication.xml#L140)|String|Postal code
[country](Communication.xml#L143)|String|Country name
[pobox](Communication.xml#L147)|String|Post office box
[ext](Communication.xml#L150)|String|Extended address (e.g., apartment or suite number)
[careof](Communication.xml#L153)|String|An intermediary who is responsible for transferring a piece of mail between the postal system and the final addressee
[label](Communication.xml#L157)|String|Delivery address label; plain-text string representing the formatted address, may contain line breaks
[type](Communication.xml#L161)|[ContactInformationType](#ContactInformationType)|Address type

## <a name="PhoneNumberType"></a>[PhoneNumberType](Communication.xml#L166)


Property|Type|Description
:-------|:---|:----------
[uri](Communication.xml#L167)|URL|This SHOULD use the tel: URL schema defined in RFC3966
[type](Communication.xml#L171)|[PhoneType](#PhoneType)|Telephone type

## <a name="EmailAddressType"></a>[EmailAddressType](Communication.xml#L176)


Property|Type|Description
:-------|:---|:----------
[address](Communication.xml#L177)|String|Email address
[type](Communication.xml#L180)|[ContactInformationType](#ContactInformationType)|Address type

## <a name="GeoDataType"></a>[GeoDataType](Communication.xml#L185)


Property|Type|Description
:-------|:---|:----------
[uri](Communication.xml#L186)|URL|This SHOULD use the geo: URL schema defined in RFC5870 which encodes the same information as an Edm.GeographyPoint
...
[to](Communication.xml#L363)|\[String\]|List of primary recipients
[cc](Communication.xml#L366)|\[String\]|List of other recipients (carbon copy)
[bcc](Communication.xml#L369)|\[String\]|List of recipients whose addresses are not to be revealed (blind carbon copy)
[subject](Communication.xml#L373)|String|Topic of the message
[body](Communication.xml#L376)|String|Main part of the message
[keywords](Communication.xml#L379)|\[String\]|List of important words and phrases that might be useful for the recipient
[received](Communication.xml#L382)|DateTimeOffset|Date and time the message was received
