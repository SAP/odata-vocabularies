...
[EndOfBusinessDate](./PersonalData.xml#L182:~:text=<TypeDefinition%20Name="-,FieldSemanticsType,-") *([Experimental](Common.md#Experimental))*|The end of business date of a record.<br>The end of business date of a legal ground or data subject record. Only fields of type `Edm.Date` or `Edm.DateTimeOffset` should be annotated.
