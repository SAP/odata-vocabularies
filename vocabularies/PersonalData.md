...
[EndOfPurposeDate](./PersonalData.xml#L182:~:text=<TypeDefinition%20Name="-,FieldSemanticsType,-") *([Experimental](Common.md#Experimental))*|The end of business date of a record.<br>The end of purpose date for a legal ground or data subject record in the sense of [GDPR article 5 (1b)](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0679-20160504&from=EN#tocId9) Only fields of type `Edm.Date` or `Edm.DateTimeOffset` should be annotated.
