...
:---|:---|:----------
[EntitySemantics](PersonalData.xml#L58)|[EntitySemanticsType](#EntitySemanticsType)|<a name="EntitySemantics"></a>Primary meaning of the entities in the annotated entity set Entities annotated with EntitySemantics are synonymous to `IsPotentiallyPersonal`.
...
[LegalEntityID](PersonalData.xml#L164) *([Experimental](Common.md#Experimental))*| (To be deprecated) The unique identifier of a legal entity<br>A legal entity is a corporation, an association, or any other organization of legal capacity, which has statutory rights and responsibilities.
