...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L305:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L308:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|ComplexType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>This parameter has properties with the same names as the key properties of the entity type. next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_CopyAction"></a>
### [Template_CopyAction](./Hierarchy.xml#L336:~:text=<Action%20Name="-,Template_CopyAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L358:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L361:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node
...
<a name="TopLevels"></a>
### [TopLevels](./Hierarchy.xml#L238:~:text=<Function%20Name="-,TopLevels,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](./Hierarchy.xml#L252:~:text=<Function%20Name="-,TopLevels,-")**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](./Hierarchy.xml#L253:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](./Hierarchy.xml#L256:~:text=<Function%20Name="-,TopLevels,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](./Hierarchy.xml#L257:~:text=<Function%20Name="-,TopLevels,-")|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](./Hierarchy.xml#L260:~:text=<Function%20Name="-,TopLevels,-")*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Show](./Hierarchy.xml#L267:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[ExpandLevels](./Hierarchy.xml#L273:~:text=<Function%20Name="-,TopLevels,-")*|\[[TopLevelsExpandType](#TopLevelsExpandType)\]|*Optional parameter:* Nodes to be expanded
[&rarr;](./Hierarchy.xml#L279:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|
...
[DrillState](./Hierarchy.xml#L61:~:text=<ComplexType%20Name="-,HierarchyType,-")|String?|Drill state of an entry<br>Possible drill states are: <dt>`expanded` <dd>if an entry precedes entries from deeper aggregation levels <dt>`collapsed` <dd>if an entry belongs to the highest non-expanded aggregation level, but not the deepest <dt>`leaf` <dd>if an entry belongs to the deepest aggregation level
...
[DrillState](./Hierarchy.xml#L130:~:text=<ComplexType%20Name="-,RecursiveHierarchyType,-")|String?|Drill state of an occurrence of a node<br>Possible drill states are: <dt>`expanded` <dd>if a node has children in the limited hierarchy <dt>`collapsed` <dd>if a node has children in the unlimited hierarchy but not in the limited hierarchy <dt>`leaf` <dd>if a node has no children in the unlimited hierarchy
...
Property|Type|Description
:-------|:---|:----------
[ChangeNextSiblingAction](./Hierarchy.xml#L197:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[QualifiedName?](Common.md#QualifiedName)|Action that moves a node among its siblings, following [this template](#Template_ChangeNextSiblingAction)
[CopyAction](./Hierarchy.xml#L205:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[QualifiedName?](Common.md#QualifiedName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)

<a name="TopLevelsExpandType"></a>
## [TopLevelsExpandType](./Hierarchy.xml#L281:~:text=<ComplexType%20Name="-,TopLevelsExpandType,-") *([Experimental](Common.md#Experimental))*
Information about nodes to be expanded

Property|Type|Description
:-------|:---|:----------
[NodeID](./Hierarchy.xml#L284:~:text=<ComplexType%20Name="-,TopLevelsExpandType,-")|String|Identifier of a node to be expanded
[Levels](./Hierarchy.xml#L287:~:text=<ComplexType%20Name="-,TopLevelsExpandType,-")|Int64?|Number of levels to be expanded, null means all levels, 0 means collapsed
