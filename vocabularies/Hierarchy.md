...
|----------|----------|-----|----------------|
|sub-hierarchy|output set of a `descendants` transformation filtering a single node identifier or an equivalent `[`Aggregation.isdescendant`](#https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Aggregation.V1.html#isdescendant) filter|US sales organizations|rows 1–2|
