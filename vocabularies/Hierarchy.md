...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L273:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L276:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>Only the key properties in this parameter are relevant. next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_ChangePreviousSiblingAction"></a>
### [Template_ChangePreviousSiblingAction](./Hierarchy.xml#L286:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L289:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[PreviousSibling](./Hierarchy.xml#L292:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")|EntityType?|Key of the node's new previous sibling S (null if the node shall become the first sibling)<br>Only the key properties in this parameter are relevant. prev(T) = S after the action. If R is a node with prev(R) = S before the action, then prev(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_CopyAction"></a>
### [Template_CopyAction](./Hierarchy.xml#L302:~:text=<Action%20Name="-,Template_CopyAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L324:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L327:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node
...
<a name="TopLevels"></a>
### [TopLevels](./Hierarchy.xml#L220:~:text=<Function%20Name="-,TopLevels,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](./Hierarchy.xml#L234:~:text=<Function%20Name="-,TopLevels,-")**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](./Hierarchy.xml#L235:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](./Hierarchy.xml#L238:~:text=<Function%20Name="-,TopLevels,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](./Hierarchy.xml#L239:~:text=<Function%20Name="-,TopLevels,-")|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](./Hierarchy.xml#L242:~:text=<Function%20Name="-,TopLevels,-")*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Expand](./Hierarchy.xml#L249:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be expanded
*[Show](./Hierarchy.xml#L255:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[Collapse](./Hierarchy.xml#L261:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be collapsed
[&rarr;](./Hierarchy.xml#L267:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|
...
Property|Type|Description
:-------|:---|:----------
[IsNode](./Hierarchy.xml#L167:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean?|Whether the entity is a node in the recursive hierarchy<br>This property is null if membership in the recursive hierarchy is not exposed in the metadata. Otherwise, if it is given as a dynamic expression based on an entity property, that property may be changed move an entity into or out of the hierarchy.
[IsStartNode](./Hierarchy.xml#L175:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean|Whether the entity is a start node for hierarchy traversal<br>If this is given as a dynamic expression based on an entity property, that property may be changed to make a node a start node. The service may start traversal with additional nodes (for example, root nodes) irrespective of this property.
[ChangeNextSiblingAction](./Hierarchy.xml#L183:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangeNextSiblingAction)
[ChangePreviousSiblingAction](./Hierarchy.xml#L186:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangePreviousSiblingAction)
[CopyAction](./Hierarchy.xml#L189:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)
