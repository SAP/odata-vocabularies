...
### [Template_MakeStartNodeAction](./Hierarchy.xml#L261:~:text=<Action%20Name="-,Template_MakeStartNodeAction,-") *([Experimental](Common.md#Experimental))*
...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L269:~:text=<Action%20Name="-,Template_MakeStartNodeAction,-")**|EntityType|**Binding parameter:** The node to be made a start node


<a name="Template_ChangeNextSiblingAction"></a>
### [Template_ChangeNextSiblingAction](./Hierarchy.xml#L273:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L276:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L279:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.
...
### [Template_CopyAction](./Hierarchy.xml#L303:~:text=<Action%20Name="-,Template_CopyAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L326:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L329:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L336:~:text=<Action%20Name="-,Template_InsertAction,-")**|EntityType|**Binding parameter:** The entity to be inserted as a new node


<a name="Template_RemoveAction"></a>
### [Template_RemoveAction](./Hierarchy.xml#L340:~:text=<Action%20Name="-,Template_RemoveAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L343:~:text=<Action%20Name="-,Template_RemoveAction,-")**|EntityType|**Binding parameter:** The node to be removed
...
<a name="TopLevels"></a>
### [TopLevels](./Hierarchy.xml#L212:~:text=<Function%20Name="-,TopLevels,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](./Hierarchy.xml#L225:~:text=<Function%20Name="-,TopLevels,-")**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](./Hierarchy.xml#L226:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](./Hierarchy.xml#L229:~:text=<Function%20Name="-,TopLevels,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](./Hierarchy.xml#L230:~:text=<Function%20Name="-,TopLevels,-")|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](./Hierarchy.xml#L233:~:text=<Function%20Name="-,TopLevels,-")*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Expand](./Hierarchy.xml#L240:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be expanded
*[Show](./Hierarchy.xml#L246:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[Collapse](./Hierarchy.xml#L252:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be collapsed
[&rarr;](./Hierarchy.xml#L258:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|
