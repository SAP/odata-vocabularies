...
Parameter|Type|Description
:--------|:---|:----------
**[Node](Hierarchy.xml#L436)**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](Hierarchy.xml#L439)|EntityType|The copied node
...
*[ShowTargets](Hierarchy.xml#L338)*|\[String\]|*Optional parameter:* Targets (for example, of end-user messages) to be shown<br>Each target has the format of the `resourcePath` ABNF rule and identifies an entity whose node in the current hierarchy is to be shown. Example: `ShowTargets=["HierarchyDirectory(1)/Nodes('A')"]`
*[ExpandLevels](Hierarchy.xml#L349)*|\[[TopLevelsExpandType](#TopLevelsExpandType)\]|*Optional parameter:* Nodes to be expanded
[&rarr;](Hierarchy.xml#L355)|\[EntityType\]|
...
## [TopLevelsExpandType](Hierarchy.xml#L357)
Information about nodes to be expanded

Property|Type|Description
:-------|:---|:----------
[NodeID](Hierarchy.xml#L359)|String|Identifier of a node to be expanded
[Levels](Hierarchy.xml#L362)|Int64?|Number of levels to be expanded, null means all levels, 0 means collapsed
