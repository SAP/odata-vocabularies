...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L253:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node to be moved
[NextSibling](./Hierarchy.xml#L256:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling (null if the node shall become the last sibling)<br>It is an error if the `NextSibling` has a different parent than the `Node`.


<a name="Template_ChangePreviousSiblingAction"></a>
### [Template_ChangePreviousSiblingAction](./Hierarchy.xml#L263:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[NextSibling](./Hierarchy.xml#L266:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")**|EntityType|**Binding parameter:** The node's new next sibling
[Node](./Hierarchy.xml#L269:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")|EntityType|Key of the node to be moved<br>It is an error if the `Node` has a different parent than the `NextSibling`.


<a name="Template_InsertAction"></a>
### [Template_InsertAction](./Hierarchy.xml#L276:~:text=<Action%20Name="-,Template_InsertAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L279:~:text=<Action%20Name="-,Template_InsertAction,-")**|EntityType|**Binding parameter:** The new root to be inserted


<a name="Template_RemoveAction"></a>
### [Template_RemoveAction](./Hierarchy.xml#L283:~:text=<Action%20Name="-,Template_RemoveAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L291:~:text=<Action%20Name="-,Template_RemoveAction,-")**|EntityType|**Binding parameter:** The leaf to be removed
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](./Hierarchy.xml#L214:~:text=<Function%20Name="-,TopLevels,-")**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](./Hierarchy.xml#L215:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](./Hierarchy.xml#L218:~:text=<Function%20Name="-,TopLevels,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](./Hierarchy.xml#L219:~:text=<Function%20Name="-,TopLevels,-")|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](./Hierarchy.xml#L222:~:text=<Function%20Name="-,TopLevels,-")*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Expand](./Hierarchy.xml#L229:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be expanded
*[Show](./Hierarchy.xml#L235:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[Collapse](./Hierarchy.xml#L241:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be collapsed
...
The resource path identifying the binding parameter MUST traverse the collection of hierarchy nodes to
which the [`RecursiveHierarchy`](#RecursiveHierarchy) annotation applies.
