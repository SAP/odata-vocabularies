...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L269:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L272:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>Only the key properties in this parameter are relevant. next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_ChangePreviousSiblingAction"></a>
### [Template_ChangePreviousSiblingAction](./Hierarchy.xml#L282:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L285:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[PreviousSibling](./Hierarchy.xml#L288:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")|EntityType?|Key of the node's new previous sibling S (null if the node shall become the first sibling)<br>Only the key properties in this parameter are relevant. prev(T) = S after the action. If R is a node with prev(R) = S before the action, then prev(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_CopyAction"></a>
### [Template_CopyAction](./Hierarchy.xml#L298:~:text=<Action%20Name="-,Template_CopyAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L320:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L323:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node
...
<a name="TopLevels"></a>
### [TopLevels](./Hierarchy.xml#L216:~:text=<Function%20Name="-,TopLevels,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](./Hierarchy.xml#L230:~:text=<Function%20Name="-,TopLevels,-")**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](./Hierarchy.xml#L231:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](./Hierarchy.xml#L234:~:text=<Function%20Name="-,TopLevels,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](./Hierarchy.xml#L235:~:text=<Function%20Name="-,TopLevels,-")|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](./Hierarchy.xml#L238:~:text=<Function%20Name="-,TopLevels,-")*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Expand](./Hierarchy.xml#L245:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be expanded
*[Show](./Hierarchy.xml#L251:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[Collapse](./Hierarchy.xml#L257:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be collapsed
...
Property|Type|Description
:-------|:---|:----------
[IsNode](./Hierarchy.xml#L167:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean?|Whether the entity is a node in the recursive hierarchy<br>This property is null if membership in the recursive hierarchy is not exposed in the metadata.
[IsStartNode](./Hierarchy.xml#L173:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean|Whether the node is a start node for hierarchy traversal<br>The service may start traversal with additional nodes (for example, root nodes) irrespective of this property.
[ChangeNextSiblingAction](./Hierarchy.xml#L179:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangeNextSiblingAction)
[ChangePreviousSiblingAction](./Hierarchy.xml#L182:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangePreviousSiblingAction)
[CopyAction](./Hierarchy.xml#L185:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)
