...
[EntityKey](./Hierarchy.xml#L343:~:text=<Action%20Name="-,Template_InsertAction,-")|EntityType|Key of the entity to become a new node<br>It is an error if the entity is already a node in the recursive hierarchy.
...
[EntityKey](./Hierarchy.xml#L370:~:text=<Action%20Name="-,Template_InsertChildAction,-")|EntityType|Key of the entity to become a new node<br>It is an error if the entity is already a node in the recursive hierarchy.
