...
## [ApplySupportedType](./Hierarchy.xml#L78:~:text=<ComplexType%20Name="-,ApplySupportedType,-") *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[IsRecursiveHierarchy](./Hierarchy.xml#L80:~:text=<ComplexType%20Name="-,ApplySupportedType,-")|Boolean|Can be set to `false` to restrict the [`RecursiveHierarchy`](#RecursiveHierarchy) annotations (irrespective of their qualifier) to certain collections of a given type
