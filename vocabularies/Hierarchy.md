...
*[Expand](./Hierarchy.xml#L232:~:text=<Function%20Name="-,TopLevels,-")*|\[[TopLevelsExpandType](#TopLevelsExpandType)\]|*Optional parameter:* Nodes to be expanded
...
Property|Type|Description
:-------|:---|:----------
[NodeID](./Hierarchy.xml#L248:~:text=<ComplexType%20Name="-,TopLevelsExpandType,-")|String|Identifier of a node to be expanded
[Levels](./Hierarchy.xml#L251:~:text=<ComplexType%20Name="-,TopLevelsExpandType,-")|Int64?|Number of levels to be expanded, null means all levels, 0 means collapsed
