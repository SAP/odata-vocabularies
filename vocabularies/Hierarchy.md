...
Parameter|Type|Description
:--------|:---|:----------
**[Node](Hierarchy.xml#L413)**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](Hierarchy.xml#L416)|EntityType|The copied node
...
Parameter|Type|Description
:--------|:---|:----------
**[InputSet](Hierarchy.xml#L306)**|\[EntityType\]|**Binding parameter**
[HierarchyNodes](Hierarchy.xml#L307)|\[EntityType\]|A collection, given through a `$root` expression
[HierarchyQualifier](Hierarchy.xml#L310)|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[NodeProperty](Hierarchy.xml#L311)|String|Property path to the node identifier, evaluated relative to the binding parameter
*[Levels](Hierarchy.xml#L314)*|Int64|*Optional parameter:* The number n of levels to be output, absent means all levels
*[Show](Hierarchy.xml#L321)*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[ExpandLevels](Hierarchy.xml#L327)*|\[[TopLevelsExpandType](#TopLevelsExpandType)\]|*Optional parameter:* Nodes to be expanded
[&rarr;](Hierarchy.xml#L333)|\[EntityType\]|
...
[ChangeSiblingForRootsSupported](Hierarchy.xml#L255)|Boolean|Whether the sibling of a root can be changed
[CopyAction](Hierarchy.xml#L258)|[QualifiedName?](Common.md#QualifiedName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)

<a name="TopLevelsExpandType"></a>
## [TopLevelsExpandType](Hierarchy.xml#L335)
Information about nodes to be expanded

Property|Type|Description
:-------|:---|:----------
[NodeID](Hierarchy.xml#L337)|String|Identifier of a node to be expanded
[Levels](Hierarchy.xml#L340)|Int64?|Number of levels to be expanded, null means all levels, 0 means collapsed
