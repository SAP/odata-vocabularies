...
[PreorderRank](./Hierarchy.xml#L123:~:text=<ComplexType%20Name="-,RecursiveHierarchyType,-")|Int64?|Preorder rank of a node<br>The preorder rank of a node is the index of the node in the sequence of nodes created from preorder traversal of the unlimited hierarchy. The first node in preorder traversal has rank 0.
