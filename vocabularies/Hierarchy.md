...
[MaintenanceActions](./Hierarchy.xml#L231:~:text=<Term%20Name="-,MaintenanceActions,-") *([Experimental](Common.md#Experimental))*|[MaintenanceActionsType](#MaintenanceActionsType)|<a name="MaintenanceActions"></a>Actions for maintaining nodes in a recursive hierarchy on the annotated entity type
...
Parameter|Type|Description
:--------|:---|:----------
**[HierarchyNodes](./Hierarchy.xml#L275:~:text=<Action%20Name="-,Template_MoveAction,-")**|\[EntityType\]|**Binding parameter**
[HierarchyQualifier](./Hierarchy.xml#L276:~:text=<Action%20Name="-,Template_MoveAction,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[Node](./Hierarchy.xml#L277:~:text=<Action%20Name="-,Template_MoveAction,-")|PrimitiveType|Node identifier of the node to be moved
[Parent](./Hierarchy.xml#L280:~:text=<Action%20Name="-,Template_MoveAction,-")|PrimitiveType?|Node identifier of the node's new parent (null if the node shall become a root)
*[KeepParents](./Hierarchy.xml#L283:~:text=<Action%20Name="-,Template_MoveAction,-")*|Boolean|*Optional parameter:* Whether the current parents of the node shall be kept in addition to the new parent
*[RemoveParent](./Hierarchy.xml#L291:~:text=<Action%20Name="-,Template_MoveAction,-")*|PrimitiveType?|*Optional parameter:* Node identifier of a parent from which the node shall be removed (null if the node shall no longer be a root)<br>This parameter is ignored if `KeepParents` is true. Otherwise, for a node with only one parent, it defaults to that parent's node identifier.
[SiblingRank](./Hierarchy.xml#L301:~:text=<Action%20Name="-,Template_MoveAction,-")|Int64?|Optional integer rank of the node among its siblings under the new parent
[&rarr;](./Hierarchy.xml#L304:~:text=<Action%20Name="-,Template_MoveAction,-")|EntityType|The node with new parents
...
Parameter|Type|Description
:--------|:---|:----------
**[HierarchyNodes](./Hierarchy.xml#L315:~:text=<Action%20Name="-,Template_RemoveAction,-")**|\[EntityType\]|**Binding parameter**
[HierarchyQualifier](./Hierarchy.xml#L316:~:text=<Action%20Name="-,Template_RemoveAction,-")|[HierarchyQualifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|
[Node](./Hierarchy.xml#L317:~:text=<Action%20Name="-,Template_RemoveAction,-")|PrimitiveType|Node identifier of the node to be removed from its parent
[RemoveParent](./Hierarchy.xml#L320:~:text=<Action%20Name="-,Template_RemoveAction,-")|PrimitiveType|Node identifier of a parent from which the node shall be removed
[&rarr;](./Hierarchy.xml#L323:~:text=<Action%20Name="-,Template_RemoveAction,-")|EntityType|The node with remaining parents
...
<a name="MaintenanceActionsType"></a>
## [MaintenanceActionsType](./Hierarchy.xml#L235:~:text=<ComplexType%20Name="-,MaintenanceActionsType,-") *([Experimental](Common.md#Experimental))*
Qualified names of actions bound to a collection of nodes of the annotated entity type

The actions MUST have the same signature as the template actions linked below, with
