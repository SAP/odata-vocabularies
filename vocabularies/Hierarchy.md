...
:--------|:---|:----------
**[Node](./Hierarchy.xml#L274:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L277:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>Only the key properties in this parameter are relevant. next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_ChangePreviousSiblingAction"></a>
### [Template_ChangePreviousSiblingAction](./Hierarchy.xml#L287:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L325:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L328:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node
...
*[Expand](./Hierarchy.xml#L250:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be expanded
*[Show](./Hierarchy.xml#L256:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be shown
*[Collapse](./Hierarchy.xml#L262:~:text=<Function%20Name="-,TopLevels,-")*|\[String\]|*Optional parameter:* Identifiers of nodes to be collapsed
[&rarr;](./Hierarchy.xml#L268:~:text=<Function%20Name="-,TopLevels,-")|\[EntityType\]|
...
Property|Type|Description
:-------|:---|:----------
[IsNode](./Hierarchy.xml#L167:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean?|Whether the entity is a node in the recursive hierarchy<br>This property is null or absent if membership in the recursive hierarchy is not exposed. Otherwise, if it is given as a dynamic expression based on an entity property, that property may be changed to move an entity into or out of the hierarchy.
[IsStartNode](./Hierarchy.xml#L175:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|Boolean|Whether the entity is a start node for hierarchy traversal by [`TopLevels`](#TopLevels)<br>This property is null or absent if being a start node is not exposed. Otherwise, if it is given as a dynamic expression based on an entity property, that property may be changed to make a node a start node. The service may start traversal with additional nodes (for example, root nodes) irrespective of this property.
[ChangeNextSiblingAction](./Hierarchy.xml#L184:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangeNextSiblingAction)
[ChangePreviousSiblingAction](./Hierarchy.xml#L187:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangePreviousSiblingAction)
[CopyAction](./Hierarchy.xml#L190:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)
