...
<a name="Template_MakeStartNodeAction"></a>
### [Template_MakeStartNodeAction](./Hierarchy.xml#L260:~:text=<Action%20Name="-,Template_MakeStartNodeAction,-") *([Experimental](Common.md#Experimental))*

Template for actions that make a node a start node and are named in [`RecursiveHierarchyActions/MakeStartNodeAction`](#RecursiveHierarchyActionsType)

Depending on the definition of start node in the recursive hierarchy, this action may fail for certain nodes.
          If the [`RecursiveHierarchy/ParentNavigationProperty`](https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Aggregation.V1.html#RecursiveHierarchy)
          is single-valued, the new start node loses a parent it may have had.

Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L268:~:text=<Action%20Name="-,Template_MakeStartNodeAction,-")**|EntityType|**Binding parameter:** The node to be made a start node


<a name="Template_ChangeNextSiblingAction"></a>
### [Template_ChangeNextSiblingAction](./Hierarchy.xml#L272:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-") *([Experimental](Common.md#Experimental))*
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L275:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[NextSibling](./Hierarchy.xml#L278:~:text=<Action%20Name="-,Template_ChangeNextSiblingAction,-")|EntityType?|Key of the node's new next sibling S (null if the node shall become the last sibling)<br>Only the key properties in this parameter are relevant. next(T) = S after the action. If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_ChangePreviousSiblingAction"></a>
### [Template_ChangePreviousSiblingAction](./Hierarchy.xml#L288:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-") *([Experimental](Common.md#Experimental))*

Template for actions that move a node among its siblings and are named in [`RecursiveHierarchyActions/ChangePreviousSiblingAction`](#RecursiveHierarchyActionsType)

Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L291:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")**|EntityType|**Binding parameter:** The node T to be moved
[PreviousSibling](./Hierarchy.xml#L294:~:text=<Action%20Name="-,Template_ChangePreviousSiblingAction,-")|EntityType?|Key of the node's new previous sibling S (null if the node shall become the first sibling)<br>Only the key properties in this parameter are relevant. prev(T) = S after the action. If R is a node with prev(R) = S before the action, then prev(R) = T after the action, even if S = null. It is an error if S has a different parent than T.


<a name="Template_CopyAction"></a>
### [Template_CopyAction](./Hierarchy.xml#L304:~:text=<Action%20Name="-,Template_CopyAction,-") *([Experimental](Common.md#Experimental))*
...
including any hierarchy directory. To give the copied sub-hierarchy a parent, the action invocation can be followed
...
Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L327:~:text=<Action%20Name="-,Template_CopyAction,-")**|EntityType|**Binding parameter:** The node to be copied
[&rarr;](./Hierarchy.xml#L330:~:text=<Action%20Name="-,Template_CopyAction,-")|EntityType|The copied node


<a name="Template_InsertAction"></a>
### [Template_InsertAction](./Hierarchy.xml#L334:~:text=<Action%20Name="-,Template_InsertAction,-") *([Experimental](Common.md#Experimental))*

Template for actions that insert a node into a recursive hierarchy and are named in [`RecursiveHierarchyActions/InsertAction`](#RecursiveHierarchyActionsType)

Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L337:~:text=<Action%20Name="-,Template_InsertAction,-")**|EntityType|**Binding parameter:** The entity to be inserted as a new node


<a name="Template_RemoveAction"></a>
### [Template_RemoveAction](./Hierarchy.xml#L341:~:text=<Action%20Name="-,Template_RemoveAction,-") *([Experimental](Common.md#Experimental))*

Template for actions that remove a node from a recursive hierarchy and are named in [`RecursiveHierarchyActions/RemoveAction`](#RecursiveHierarchyActionsType)

Parameter|Type|Description
:--------|:---|:----------
**[Node](./Hierarchy.xml#L344:~:text=<Action%20Name="-,Template_RemoveAction,-")**|EntityType|**Binding parameter:** The node to be removed
...
Property|Type|Description
:-------|:---|:----------
[MakeStartNodeAction](./Hierarchy.xml#L165:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that makes a node a start node, following [this template](#Template_MakeStartNodeAction)
[ChangeNextSiblingAction](./Hierarchy.xml#L168:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangeNextSiblingAction)
[ChangePreviousSiblingAction](./Hierarchy.xml#L171:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that moves a node among its siblings, following [this template](#Template_ChangePreviousSiblingAction)
[CopyAction](./Hierarchy.xml#L174:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that copies a node and its descendants, following [this template](#Template_CopyAction)
[InsertAction](./Hierarchy.xml#L177:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that inserts a node into a recursive hierarchy, following [this template](#Template_InsertAction)
[RemoveAction](./Hierarchy.xml#L180:~:text=<ComplexType%20Name="-,RecursiveHierarchyActionsType,-")|[NamespaceQualifiedActionName?](Common.md#NamespaceQualifiedActionName)|Action that removes a node from a recursive hierarchy, following [this template](#Template_RemoveAction)
