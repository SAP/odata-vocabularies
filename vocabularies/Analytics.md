...
[UpdatableProperties](./Analytics.xml#L211:~:text=<ComplexType%20Name="-,UpdateActionType,-")|\[PropertyPath\]|Declared properties of the aggregate entity that can be updated with the action<br>A declared property whose name equals a custom aggregate can be updated, which means updating the aggregate value.
