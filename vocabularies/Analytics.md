...
:--------|:---|:----------
**[InputSet](./Analytics.xml#L210:~:text=<Function%20Name="-,AutoExpand,-")**|\[EntityType\]|**Binding parameter:** Entity set to be processed
[Levels](./Analytics.xml#L213:~:text=<Function%20Name="-,AutoExpand,-")|\[[AutoExpandLevel](#AutoExpandLevel)\]|Collection of aggregation levels forming the visible part of a leveled hierarchy<br>Each element in the collection defines the properties that constitute one level. A property must not referenced by more than one level. The first element in the collection defines the property names of the coarsest level, the following elements define the property names of consecutively finer-grained aggregation levels. The function result comprises the leveled hierarchy with these levels in preorder. All referenced properties must be groupable.
[Aggregation](./Analytics.xml#L224:~:text=<Function%20Name="-,AutoExpand,-")|\[String\]|Properties to aggregate for all result entries on all levels<br>All properties in this collection must be custom aggregates.
[SiblingOrder](./Analytics.xml#L230:~:text=<Function%20Name="-,AutoExpand,-")|\[[AutoExpandSiblingOrder](#AutoExpandSiblingOrder)\]|Sort specification to apply to all direct descendants of a given entry in the resulting leveled hierarchy
*[ExpandLevels](./Analytics.xml#L233:~:text=<Function%20Name="-,AutoExpand,-")*|\[[AutoExpandLevelType](#AutoExpandLevelType)\]|*Optional parameter:* Entries to be specially (not fully) expanded
[&rarr;](./Analytics.xml#L239:~:text=<Function%20Name="-,AutoExpand,-")|\[EntityType\]|Output set including the instance annotation [`LevelInformation`](#LevelInformation)
...
## [AutoExpandLevel](./Analytics.xml#L243:~:text=<ComplexType%20Name="-,AutoExpandLevel,-") *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[P](./Analytics.xml#L245:~:text=<ComplexType%20Name="-,AutoExpandLevel,-")|\[String\]|A non-empty set of property names constituting a level

<a name="AutoExpandSiblingOrder"></a>
## [AutoExpandSiblingOrder](./Analytics.xml#L249:~:text=<ComplexType%20Name="-,AutoExpandSiblingOrder,-") *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Property](./Analytics.xml#L251:~:text=<ComplexType%20Name="-,AutoExpandSiblingOrder,-")|String|Property by which to sort
[Order](./Analytics.xml#L254:~:text=<ComplexType%20Name="-,AutoExpandSiblingOrder,-")|[SortOrderType](#SortOrderType)|Sorting direction

<a name="SortOrderType"></a>
## [SortOrderType](./Analytics.xml#L258:~:text=<TypeDefinition%20Name="-,SortOrderType,-") *([Experimental](Common.md#Experimental))*
**Type:** String
...
:------------|:----------
[asc](./Analytics.xml#L262:~:text=<TypeDefinition%20Name="-,SortOrderType,-")|Sort in ascending order
[desc](./Analytics.xml#L266:~:text=<TypeDefinition%20Name="-,SortOrderType,-")|Sort in descending order

<a name="AutoExpandLevelType"></a>
## [AutoExpandLevelType](./Analytics.xml#L273:~:text=<ComplexType%20Name="-,AutoExpandLevelType,-") *([Experimental](Common.md#Experimental))*
Information about entries in a leveled hierarchy that are not completely expanded

Property|Type|Description
:-------|:---|:----------
[Entry](./Analytics.xml#L276:~:text=<ComplexType%20Name="-,AutoExpandLevelType,-")|\[String\]|An entry on a given [level](#AutoExpandLevel) is identified by a collection of values for the properties that constitute all levels up to the given one
[Levels](./Analytics.xml#L279:~:text=<ComplexType%20Name="-,AutoExpandLevelType,-")|Int64|Number of levels to be expanded, 0 means collapsed
