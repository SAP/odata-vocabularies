...
[StructureElement](Analytics.xml#L170)|[StructureElementType](#StructureElementType)|<a name="StructureElement"></a>A collection of entities is structured into several subsets, each `StructureElement` describes one subset<br>Can be annotated with:<ul><li>[Label](Common.md#Label)</li></ul>
[Structure](Analytics.xml#L184)|\[AnnotationPath\]|<a name="Structure"></a><br>Can be annotated with:<ul><li>[Label](Common.md#Label)</li></ul><br>Allowed terms:<ul><li>[StructureElement](#StructureElement)</li></ul>
...
## [StructureElementType](Analytics.xml#L178)


Property|Type|Description
:-------|:---|:----------
[Filter](Analytics.xml#L179)|Boolean?|Whether an entity belongs to one subset of the structure
