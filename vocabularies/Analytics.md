...
## [StructureElementType](Analytics.xml#L193)


Property|Type|Description
:-------|:---|:----------
[Filter](Analytics.xml#L199)|Boolean?|Whether an entity belongs to the subset<br>The values is given as a dynamic expression that is evaluated relative to the entity.
