...
[DataGrid](UI.xml#L705) *([Experimental](Common.md#Experimental))*|[DataGridType](#DataGridType)|<a name="DataGrid"></a>Visualization of a data grid
[Chart](UI.xml#L760)|[ChartDefinitionType](#ChartDefinitionType)|<a name="Chart"></a>Visualization of multiple data points
[ValueCriticality](UI.xml#L984) *([Experimental](Common.md#Experimental))*|\[[ValueCriticalityType](#ValueCriticalityType)\]|<a name="ValueCriticality"></a>Assign criticalities to primitive values. This information can be used for semantic coloring.
[CriticalityLabels](UI.xml#L997) *([Experimental](Common.md#Experimental))*|\[[CriticalityLabelType](#CriticalityLabelType)\]|<a name="CriticalityLabels"></a>Assign labels to criticalities. This information can be used for semantic coloring. When applied to a property, a label for a criticality must be provided, if more than one value of the annotated property has been assigned to the same criticality. There must be no more than one label per criticality.
[SelectionFields](UI.xml#L1018)|\[PropertyPath\]|<a name="SelectionFields"></a>Properties that might be relevant for filtering a collection of entities of this type
[Facets](UI.xml#L1025)|\[[Facet](#Facet)\]|<a name="Facets"></a>Collection of facets
[HeaderFacets](UI.xml#L1029)|\[[Facet](#Facet)\]|<a name="HeaderFacets"></a>Facets for additional object header information
[QuickViewFacets](UI.xml#L1033)|\[[Facet](#Facet)\]|<a name="QuickViewFacets"></a>Facets that may be used for a quick overview of the object
[QuickCreateFacets](UI.xml#L1037)|\[[Facet](#Facet)\]|<a name="QuickCreateFacets"></a>Facets that may be used for a (quick) create of the object
[FilterFacets](UI.xml#L1041)|\[[ReferenceFacet](#ReferenceFacet)\]|<a name="FilterFacets"></a>Facets that reference UI.FieldGroup annotations to group filterable fields
[SelectionPresentationVariant](UI.xml#L1115)|[SelectionPresentationVariantType](#SelectionPresentationVariantType)|<a name="SelectionPresentationVariant"></a>A SelectionPresentationVariant bundles a Selection Variant and a Presentation Variant
[PresentationVariant](UI.xml#L1139)|[PresentationVariantType](#PresentationVariantType)|<a name="PresentationVariant"></a>Defines how the result of a queried collection of entities is shaped and how this result is displayed
[SelectionVariant](UI.xml#L1256)|[SelectionVariantType](#SelectionVariantType)|<a name="SelectionVariant"></a>A SelectionVariant denotes a combination of parameters and filters to query the annotated entity set
[ThingPerspective](UI.xml#L1412)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="ThingPerspective"></a>The annotated term is a Thing Perspective
[IsSummary](UI.xml#L1415)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="IsSummary"></a>This Facet and all included Facets are the summary of the thing. At most one Facet of a thing can be tagged with this term
[PartOfPreview](UI.xml#L1419)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="PartOfPreview"></a>This record and all included structural elements are part of the Thing preview<br>This term can be applied e.g. to UI.Facet and UI.DataField
[Map](UI.xml#L1423)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="Map"></a>Target MUST reference a UI.GeoLocation, Communication.Address or a collection of these
[Gallery](UI.xml#L1427)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="Gallery"></a>Target MUST reference a UI.MediaResource
[IsImageURL](UI.xml#L1432)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="IsImageURL"></a>Properties and terms annotated with this term MUST contain a valid URL referencing an resource with a MIME type image<br>Can be annotated with:<ul><li>[IsNaturalPerson](Common.md#IsNaturalPerson)</li></ul>
[IsImage](UI.xml#L1442) *([Experimental](Common.md#Experimental))*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="IsImage"></a>Properties annotated with this term MUST be a stream property annotated with a MIME type image. Entity types annotated with this term MUST be a media entity type annotated with a MIME type image.<br>Can be annotated with:<ul><li>[IsNaturalPerson](Common.md#IsNaturalPerson)</li></ul>
[MultiLineText](UI.xml#L1453)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="MultiLineText"></a>Properties and parameters annotated with this annotation should be rendered as multi-line text (e.g. text area)
[Placeholder](UI.xml#L1458)|String|<a name="Placeholder"></a>A short, human-readable text that gives a hint or an example to help the user with data entry
[InputMask](UI.xml#L1463) *([Experimental](Common.md#Experimental))*|[InputMaskType](#InputMaskType)|<a name="InputMask"></a>Properties or parameters annotated with this term will get a mask in edit mode<br>Input masks improve readability and help to enter data correctly. So, masks can be especially useful for input fields that have a fixed pattern, e.g. DUNS numbers or similar. [Here](../examples/UI.InputMask-sample.xml) you can find an example for this annotation
[TextArrangement](UI.xml#L1497)|[TextArrangementType](#TextArrangementType)|<a name="TextArrangement"></a>Describes the arrangement of a code or ID value and its text<br><p>This term annotates one of the following:</p> <ol type="1"> <li>a <a href="Common.md#Text"><code>Common.Text</code></a> annotation of the code or ID property where the annotation value is the text</li> <li>an entity type, this has the same effect as annotating all <code>Common.Text</code> annotations of properties of that entity type.</li> </ol> 
[DateTimeStyle](UI.xml#L1520) *([Experimental](Common.md#Experimental))*|String?|<a name="DateTimeStyle"></a>The temporal value represented by the annotated property or parameter shall be shown on the UI in the given style<br>Requires type `Edm.Date`, `Edm.TimeOfDay`, or `Edm.DateTimeOffset`. If this annotation is absent or null or an empty string, temporal values are shown in a default style.<dl>Allowed values:<dt>[short](UI.xml#L1529)<dd>7/25/24, 1:11 PM<dt>[medium](UI.xml#L1533)<dd>Jul 25, 2024, 1:11:51 PM<dt>[long](UI.xml#L1537)<dd>July 25, 2024 at 1:11:51 PM GMT+2<dt>[full](UI.xml#L1541)<dd>Thursday, July 25, 2024 at 1:11:51 PM Central European Summer Time</dl>
[Note](UI.xml#L1549) *([Experimental](Common.md#Experimental))*|[NoteType](#NoteType)|<a name="Note"></a>Visualization of a note attached to an entity<br>Administrative data is given by the annotations [`Common.CreatedBy`](Common.md#CreatedBy), [`Common.CreatedAt`](Common.md#CreatedAt), [`Common.ChangedBy`](Common.md#ChangedBy), [`Common.ChangedAt`](Common.md#ChangedAt) on the same entity type.
[Importance](UI.xml#L1602)|[ImportanceType](#ImportanceType)|<a name="Importance"></a>Expresses the importance of e.g. a DataField or an annotation
...
## [DataGridType](UI.xml#L710) *([Experimental](Common.md#Experimental))*
...
- Exactly one facet targeting a FieldGroupMeasures must be referenced by `Columns` and `Rows` together.
- At most one facet targeting a Structure may be referenced by `Columns` and `Rows` together.

Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L717)|String?|Title of the grid
[Description](UI.xml#L721)|String?|Short description
[Columns](UI.xml#L725)|\[[ReferenceFacet](#ReferenceFacet)\]|Columns of the grid<br>Allowed terms:<ul><li>[FieldGroup](#FieldGroup)</li><li>[Structure](Analytics.md#Structure)</li></ul>
[Rows](UI.xml#L734)|\[[ReferenceFacet](#ReferenceFacet)\]|Rows of the grid<br>Allowed terms:<ul><li>[FieldGroup](#FieldGroup)</li><li>[Structure](Analytics.md#Structure)</li></ul>
[Actions](UI.xml#L743)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Available actions

<a name="FieldGroupDimensions"></a>
## [FieldGroupDimensions](UI.xml#L747): [FieldGroupType](#FieldGroupType) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[*Label*](UI.xml#L162)|String?|Label for the field group
[Data](UI.xml#L749)|\[[DataField?](#DataField)\]|Collection of data fields whose `Value` properties occur in [`Analytics.AnalyticalContext/Dimensions`](Analytics.md#AnalyticalContextType)

<a name="FieldGroupMeasures"></a>
## [FieldGroupMeasures](UI.xml#L753): [FieldGroupType](#FieldGroupType) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[*Label*](UI.xml#L162)|String?|Label for the field group
[Data](UI.xml#L755)|\[[DataField?](#DataField)\]|Collection of data fields whose `Value` properties occur in [`Analytics.AnalyticalContext/Measures`](Analytics.md#AnalyticalContextType)

<a name="ChartDefinitionType"></a>
## [ChartDefinitionType](UI.xml#L764)


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L765)|String?|Title of the chart
[Description](UI.xml#L769)|String?|Short description
[ChartType](UI.xml#L773)|[ChartType](#ChartType)|Chart type
[AxisScaling](UI.xml#L776)|[ChartAxisScalingType?](#ChartAxisScalingType)|Describes the scale of the chart value axes
[Measures](UI.xml#L779)|\[PropertyPath\]|Measures of the chart, e.g. size and color in a bubble chart
[DynamicMeasures](UI.xml#L783)|\[AnnotationPath\]|Dynamic properties introduced by annotations and used as measures of the chart<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[MeasureAttributes](UI.xml#L796)|\[[ChartMeasureAttributeType](#ChartMeasureAttributeType)\]|Describes Attributes for Measures. All Measures used in this collection must also be part of the Measures Property.
[Dimensions](UI.xml#L801)|\[PropertyPath\]|Dimensions of the chart, e.g. x- and y-axis of a bubble chart
[DimensionAttributes](UI.xml#L804)|\[[ChartDimensionAttributeType](#ChartDimensionAttributeType)\]|Describes Attributes for Dimensions. All Dimensions used in this collection must also be part of the Dimensions Property.
[Actions](UI.xml#L809)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Available actions

<a name="ChartType"></a>
## [ChartType](UI.xml#L814)


Member|Value|Description
:-----|----:|:----------
[Column](UI.xml#L815)|0|
[ColumnStacked](UI.xml#L816)|1|
[ColumnDual](UI.xml#L817)|2|
[ColumnStackedDual](UI.xml#L818)|3|
[ColumnStacked100](UI.xml#L819)|4|
[ColumnStackedDual100](UI.xml#L820)|5|
[Bar](UI.xml#L821)|6|
[BarStacked](UI.xml#L822)|7|
[BarDual](UI.xml#L823)|8|
[BarStackedDual](UI.xml#L824)|9|
[BarStacked100](UI.xml#L825)|10|
[BarStackedDual100](UI.xml#L826)|11|
[Area](UI.xml#L827)|12|
[AreaStacked](UI.xml#L828)|13|
[AreaStacked100](UI.xml#L829)|14|
[HorizontalArea](UI.xml#L830)|15|
[HorizontalAreaStacked](UI.xml#L831)|16|
[HorizontalAreaStacked100](UI.xml#L832)|17|
[Line](UI.xml#L833)|18|
[LineDual](UI.xml#L834)|19|
[Combination](UI.xml#L835)|20|
[CombinationStacked](UI.xml#L836)|21|
[CombinationDual](UI.xml#L837)|22|
[CombinationStackedDual](UI.xml#L838)|23|
[HorizontalCombinationStacked](UI.xml#L839)|24|
[Pie](UI.xml#L840)|25|
[Donut](UI.xml#L841)|26|
[Scatter](UI.xml#L842)|27|
[Bubble](UI.xml#L843)|28|
[Radar](UI.xml#L844)|29|
[HeatMap](UI.xml#L845)|30|
[TreeMap](UI.xml#L846)|31|
[Waterfall](UI.xml#L847)|32|
[Bullet](UI.xml#L848)|33|
[VerticalBullet](UI.xml#L849)|34|
[HorizontalWaterfall](UI.xml#L850)|35|
[HorizontalCombinationDual](UI.xml#L851)|36|
[HorizontalCombinationStackedDual](UI.xml#L852)|37|
[Donut100](UI.xml#L853) *([Experimental](Common.md#Experimental))*|38|

<a name="ChartAxisScalingType"></a>
## [ChartAxisScalingType](UI.xml#L859)


Property|Type|Description
:-------|:---|:----------
[ScaleBehavior](UI.xml#L860)|[ChartAxisScaleBehaviorType](#ChartAxisScaleBehaviorType)|Scale is fixed or adapts automatically to rendered values
[AutoScaleBehavior](UI.xml#L863)|[ChartAxisAutoScaleBehaviorType?](#ChartAxisAutoScaleBehaviorType)|Settings for automatic scaling
[FixedScaleMultipleStackedMeasuresBoundaryValues](UI.xml#L866)|[FixedScaleMultipleStackedMeasuresBoundaryValuesType?](#FixedScaleMultipleStackedMeasuresBoundaryValuesType)|Boundary values for fixed scaling of a stacking chart type with multiple measures

<a name="ChartAxisScaleBehaviorType"></a>
## [ChartAxisScaleBehaviorType](UI.xml#L871)


Member|Value|Description
:-----|----:|:----------
[AutoScale](UI.xml#L872)|0|Value axes scale automatically
[FixedScale](UI.xml#L875)|1|Fixed minimum and maximum values are applied, which are derived from the @UI.MeasureAttributes.DataPoint/MinimumValue and .../MaximumValue annotation by default. For stacking chart types with multiple measures, they are taken from ChartAxisScalingType/FixedScaleMultipleStackedMeasuresBoundaryValues.

<a name="ChartAxisAutoScaleBehaviorType"></a>
## [ChartAxisAutoScaleBehaviorType](UI.xml#L884)


Property|Type|Description
:-------|:---|:----------
[ZeroAlwaysVisible](UI.xml#L885)|Boolean|Forces the value axis to always display the zero value
[DataScope](UI.xml#L888)|[ChartAxisAutoScaleDataScopeType](#ChartAxisAutoScaleDataScopeType)|Determines the automatic scaling

<a name="ChartAxisAutoScaleDataScopeType"></a>
## [ChartAxisAutoScaleDataScopeType](UI.xml#L893)


Member|Value|Description
:-----|----:|:----------
[DataSet](UI.xml#L894)|0|Minimum and maximum axes values are determined from the entire data set
[VisibleData](UI.xml#L897)|1|Minimum and maximum axes values are determined from the currently visible data. Scrolling will change the scale.

<a name="FixedScaleMultipleStackedMeasuresBoundaryValuesType"></a>
## [FixedScaleMultipleStackedMeasuresBoundaryValuesType](UI.xml#L902)


Property|Type|Description
:-------|:---|:----------
[MinimumValue](UI.xml#L903)|Decimal|Minimum value on value axes
[MaximumValue](UI.xml#L906)|Decimal|Maximum value on value axes

<a name="ChartDimensionAttributeType"></a>
## [ChartDimensionAttributeType](UI.xml#L911)


Property|Type|Description
:-------|:---|:----------
[Dimension](UI.xml#L912)|PropertyPath?|
[Role](UI.xml#L913)|[ChartDimensionRoleType?](#ChartDimensionRoleType)|
[HierarchyLevel](UI.xml#L914) *([Experimental](Common.md#Experimental))*|Int32?|For a dimension with a hierarchy, members are selected from this level. The root node of the hierarchy is at level 0.
[ValuesForSequentialColorLevels](UI.xml#L918) *([Experimental](Common.md#Experimental))*|\[String\]|All values in this collection should be assigned to levels of the same color.
[EmphasizedValues](UI.xml#L922) *([Experimental](Common.md#Experimental))*|\[String\]|All values in this collection should be emphasized.
[EmphasisLabels](UI.xml#L926) *([Experimental](Common.md#Experimental))*|[EmphasisLabelType?](#EmphasisLabelType)|Assign a label to values with an emphasized representation. This is required, if more than one emphasized value has been specified.

<a name="ChartMeasureAttributeType"></a>
## [ChartMeasureAttributeType](UI.xml#L932)
Exactly one of `Measure` and `DynamicMeasure` must be present

Property|Type|Description
:-------|:---|:----------
[Measure](UI.xml#L934)|PropertyPath?|
[DynamicMeasure](UI.xml#L937)|AnnotationPath?|Dynamic property introduced by an annotation and used as a measure in a chart<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[Role](UI.xml#L950)|[ChartMeasureRoleType?](#ChartMeasureRoleType)|
[DataPoint](UI.xml#L951)|AnnotationPath?|Annotation path MUST end in @UI.DataPoint and the data point's Value MUST be the same property as in Measure<br>Allowed terms:<ul><li>[DataPoint](#DataPoint)</li></ul>
[UseSequentialColorLevels](UI.xml#L959) *([Experimental](Common.md#Experimental))*|Boolean|All measures for which this setting is true should be assigned to levels of the same color.

<a name="ChartDimensionRoleType"></a>
## [ChartDimensionRoleType](UI.xml#L965)


Member|Value|Description
:-----|----:|:----------
[Category](UI.xml#L966)|0|
[Series](UI.xml#L967)|1|
[Category2](UI.xml#L968)|2|

<a name="ChartMeasureRoleType"></a>
## [ChartMeasureRoleType](UI.xml#L971)
...
## [EmphasisLabelType](UI.xml#L977) *([Experimental](Common.md#Experimental))*
Assigns a label to the set of emphasized values and optionally also for non-emphasized values. This information can be used for semantic coloring.

Property|Type|Description
:-------|:---|:----------
[EmphasizedValuesLabel](UI.xml#L980)|String|
[NonEmphasizedValuesLabel](UI.xml#L981)|String?|

<a name="ValueCriticalityType"></a>
## [ValueCriticalityType](UI.xml#L988) *([Experimental](Common.md#Experimental))*
Assigns a fixed criticality to a primitive value. This information can be used for semantic coloring.

Property|Type|Description
:-------|:---|:----------
[Value](UI.xml#L991)|PrimitiveType?|MUST be a fixed value of primitive type
[Criticality](UI.xml#L994)|[CriticalityType?](#CriticalityType)|

<a name="CriticalityLabelType"></a>
## [CriticalityLabelType](UI.xml#L1008) *([Experimental](Common.md#Experimental))*
Assigns a label to a criticality. This information can be used for semantic coloring.

Property|Type|Description
:-------|:---|:----------
[Criticality](UI.xml#L1011)|[CriticalityType](#CriticalityType)|
[Label](UI.xml#L1012)|String|Criticality label
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1053)|String?|Facet label
[ID](UI.xml#L1057)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
...
## [CollectionFacet](UI.xml#L1061): [Facet](#Facet)
...
[*Label*](UI.xml#L1053)|String?|Facet label
[*ID*](UI.xml#L1057)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
[Facets](UI.xml#L1063)|\[[Facet](#Facet)\]|Nested facets. An empty collection may be used as a placeholder for content added via extension points.
...
## [ReferenceFacet](UI.xml#L1067): [Facet](#Facet)
...
## [ReferenceURLFacet](UI.xml#L1097): [Facet](#Facet)
...
[*Label*](UI.xml#L1053)|String?|Facet label
[*ID*](UI.xml#L1057)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
[Url](UI.xml#L1099)|URL|URL of referenced information<br>Can be annotated with:<ul><li>[LinkTarget](HTML5.md#LinkTarget)</li></ul>
[UrlContentType](UI.xml#L1108)|MediaType?|Media type of referenced information
...
## [SelectionPresentationVariantType](UI.xml#L1121)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1122)|String?|Optional identifier to reference this variant from an external context
[Text](UI.xml#L1127)|String?|Name of the bundling variant
[SelectionVariant](UI.xml#L1131)|[SelectionVariantType](#SelectionVariantType)|Selection variant, either specified inline or referencing another annotation via Path
[PresentationVariant](UI.xml#L1134)|[PresentationVariantType](#PresentationVariantType)|Presentation variant, either specified inline or referencing another annotation via Path

<a name="PresentationVariantType"></a>
## [PresentationVariantType](UI.xml#L1145)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1146)|String?|Optional identifier to reference this variant from an external context
[Text](UI.xml#L1149)|String?|Name of the presentation variant
[MaxItems](UI.xml#L1153)|Int32?|Maximum number of items that should be included in the result
[SortOrder](UI.xml#L1156)|\[[SortOrderType](Common.md#SortOrderType)\]|Collection can be provided inline or as a reference to a Common.SortOrder annotation via Path
[GroupBy](UI.xml#L1159)|\[PropertyPath\]|Sequence of groupable properties p1, p2, ... defining how the result is composed of instances representing groups, one for each combination of value properties in the queried collection. The sequence specifies a certain level of aggregation for the queried collection, and every group instance will provide aggregated values for properties that are aggregatable. Moreover, the series of sub-sequences (p1), (p1, p2), ... forms a leveled hierarchy, which may become relevant in combination with `InitialExpansionLevel`.
[TotalBy](UI.xml#L1168)|\[PropertyPath\]|Sub-sequence q1, q2, ... of properties p1, p2, ... specified in GroupBy. With this, additional levels of aggregation are requested in addition to the most granular level defined by GroupBy: Every element in the series of sub-sequences (q1), (q1, q2), ... introduces an additional aggregation level included in the result.
[Total](UI.xml#L1175)|\[PropertyPath\]|Aggregatable properties for which aggregated values should be provided for the additional aggregation levels specified in TotalBy.
[DynamicTotal](UI.xml#L1181)|\[AnnotationPath\]|Dynamic properties introduced by annotations for which aggregated values should be provided for the additional aggregation levels specified in TotalBy<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being presented according to the `UI.PresentationVariant` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[IncludeGrandTotal](UI.xml#L1194)|Boolean|Result should include a grand total for the properties specified in Total
[InitialExpansionLevel](UI.xml#L1197)|Int32|Level up to which the hierarchy defined for the queried collection should be expanded initially. The hierarchy may be implicitly imposed by the sequence of the GroupBy, or by an explicit hierarchy annotation.
[Visualizations](UI.xml#L1203)|\[AnnotationPath\]|Lists available visualization types. Currently supported types are `UI.LineItem`, `UI.Chart`, and `UI.DataPoint`. For each type, no more than a single annotation is meaningful. Multiple instances of the same visualization type shall be modeled with different presentation variants. A reference to `UI.Lineitem` should always be part of the collection (least common denominator for renderers). The first entry of the collection is the default visualization.<br>Allowed terms:<ul><li>[Chart](#Chart)</li><li>[DataPoint](#DataPoint)</li><li>[LineItem](#LineItem)</li></ul>
[RecursiveHierarchyQualifier](UI.xml#L1220) *([Experimental](Common.md#Experimental))*|[HierarchyQualifier?](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|Qualifier of the recursive hierarchy that should be applied to the Visualization
[RequestAtLeast](UI.xml#L1224)|\[PropertyPath\]|Properties that should always be included in the result of the queried collection<br>Properties in `RequestAtLeast` must occur either in the `$select` clause of an OData request or among the grouping properties in an `$apply=groupby((grouping properties),...)` clause of an aggregating OData request.
[SelectionFields](UI.xml#L1247) *([Experimental](Common.md#Experimental))*|\[PropertyPath\]|Properties that should be presented for filtering a collection of entities. Can be provided inline or as a reference to a `UI.SelectionFields` annotation via Path.

<a name="SelectionVariantType"></a>
## [SelectionVariantType](UI.xml#L1261)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1262)|String?|May contain identifier to reference this instance from an external context
[Text](UI.xml#L1267)|String?|Name of the selection variant
[Parameters](UI.xml#L1271)|\[[ParameterAbstract](#ParameterAbstract)\]|Parameters of the selection variant
[FilterExpression](UI.xml#L1274)|String?|Filter string for query part of URL, without `$filter=`
[SelectOptions](UI.xml#L1279)|\[[SelectOptionType](#SelectOptionType)\]|ABAP Select Options Pattern

<a name="ParameterAbstract"></a>
## [*ParameterAbstract*](UI.xml#L1286)
...
<a name="Parameter"></a>
## [Parameter](UI.xml#L1289): [ParameterAbstract](#ParameterAbstract)
Single-valued parameter

Property|Type|Description
:-------|:---|:----------
[PropertyName](UI.xml#L1291)|PropertyPath|Path to a key property of a parameter entity type
[PropertyValue](UI.xml#L1294)|PrimitiveType|Value for the key property

<a name="IntervalParameter"></a>
## [IntervalParameter](UI.xml#L1298): [ParameterAbstract](#ParameterAbstract)
Interval parameter formed with a 'from' and a 'to' property

Property|Type|Description
:-------|:---|:----------
[PropertyNameFrom](UI.xml#L1300)|PropertyPath|Path to the 'from' property of a parameter entity type
[PropertyValueFrom](UI.xml#L1303)|PrimitiveType|Value for the 'from' property
[PropertyNameTo](UI.xml#L1306)|PropertyPath|Path to the 'to' property of a parameter entity type
[PropertyValueTo](UI.xml#L1309)|PrimitiveType|Value for the 'to' property

<a name="SelectOptionType"></a>
## [SelectOptionType](UI.xml#L1314)
...
Property|Type|Description
:-------|:---|:----------
[PropertyName](UI.xml#L1317)|PropertyPath?|Path to the property
[DynamicPropertyName](UI.xml#L1329)|AnnotationPath?|Dynamic property introduced by annotations for which value ranges are specified<br>If the annotation referenced by the annotation path does not apply to the same collection of entities as the one being filtered according to the `UI.SelectionVariant` annotation, this instance of `UI.SelectionVariant/SelectOptions` MUST be silently ignored. For an example, see the `UI.SelectionVariant` annotation in the [example](../examples/DynamicProperties-sample.xml).<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[Ranges](UI.xml#L1343)|\[[SelectionRangeType](#SelectionRangeType)\]|List of value ranges

<a name="SelectionRangeType"></a>
## [SelectionRangeType](UI.xml#L1348)
Value range. If the range option only requires a single value, the value must be in the property Low

Property|Type|Description
:-------|:---|:----------
[Sign](UI.xml#L1352)|[SelectionRangeSignType](#SelectionRangeSignType)|Include or exclude values
[Option](UI.xml#L1355)|[SelectionRangeOptionType](#SelectionRangeOptionType)|Comparison operator
[Low](UI.xml#L1358)|PrimitiveType|Single value or lower interval boundary
[High](UI.xml#L1361)|PrimitiveType?|Upper interval boundary

<a name="SelectionRangeSignType"></a>
## [SelectionRangeSignType](UI.xml#L1366)


Member|Value|Description
:-----|----:|:----------
[I](UI.xml#L1367)|0|Inclusive
[E](UI.xml#L1370)|1|Exclusive

<a name="SelectionRangeOptionType"></a>
## [SelectionRangeOptionType](UI.xml#L1375)
Comparison operator

Member|Value|Description
:-----|----:|:----------
[EQ](UI.xml#L1377)|0|Equal to
[BT](UI.xml#L1380)|1|Between
[CP](UI.xml#L1383)|2|Contains pattern
[LE](UI.xml#L1386)|3|Less than or equal to
[GE](UI.xml#L1389)|4|Greater than or equal to
[NE](UI.xml#L1392)|5|Not equal to
[NB](UI.xml#L1395)|6|Not between
[NP](UI.xml#L1398)|7|Does not contain pattern
[GT](UI.xml#L1401)|8|Greater than
[LT](UI.xml#L1404)|9|Less than

<a name="InputMaskType"></a>
## [InputMaskType](UI.xml#L1472) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Mask](UI.xml#L1474)|String|The mask to be applied to the property or the parameter
[PlaceholderSymbol](UI.xml#L1477)|String|A single character symbol to be shown where the user can type a character
[Rules](UI.xml#L1480)|\[[InputMaskRuleType](#InputMaskRuleType)\]|Rules that define valid values for one symbol in the mask<br>The following rules are defined as default and don't need to be listed here: * = ., C = [a-zA-Z], 9 = [0-9]

<a name="InputMaskRuleType"></a>
## [InputMaskRuleType](UI.xml#L1487) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[MaskSymbol](UI.xml#L1489)|String|A symbol in the mask that stands for a regular expression which must be matched by the user input in every position where this symbol occurs
[RegExp](UI.xml#L1492)|String|Regular expression that defines the valid values for the mask symbol

<a name="TextArrangementType"></a>
## [TextArrangementType](UI.xml#L1505)


Member|Value|Description
:-----|----:|:----------
[TextFirst](UI.xml#L1506)|0|Text is first, followed by the code/ID (e.g. in parentheses)
[TextLast](UI.xml#L1509)|1|Code/ID is first, followed by the text (e.g. separated by a dash)
[TextSeparate](UI.xml#L1512)|2|Code/ID and text are represented separately (code/ID will be shown and text can be visualized in a separate place)
[TextOnly](UI.xml#L1515)|3|Only text is represented, code/ID is hidden (e.g. for UUIDs)

<a name="NoteType"></a>
## [NoteType](UI.xml#L1561) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L1563)|String?|Title of the note<br>The title of a note is hidden with an annotation `@UI.Note/Title/@UI.Hidden`, not with an annotation on the property targeted by `@UI.Note/Title`.<br>Can be annotated with:<ul><li>[Hidden](#Hidden)</li></ul>
[Content](UI.xml#L1575)|String|Content of the note, as a string<br>The property targeted by `@UI.Note/Content` must be annotated with `Core.MediaType` and may be annotated with `Common.SAPObjectNodeTypeReference`. When it is tagged with `Core.IsLanguageDependent`, another property of the same entity type that is tagged with [`Common.IsLanguageIdentifier`](Common.md#IsLanguageIdentifier) determines the language of the note.<br>Can be annotated with:<ul><li>[MediaType](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#MediaType)</li><li>[IsLanguageDependent](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#IsLanguageDependent)</li><li>[SAPObjectNodeTypeReference](Common.md#SAPObjectNodeTypeReference)</li></ul>
[Type](UI.xml#L1591)|String|A type used for grouping notes
[MaximalLength](UI.xml#L1594)|Int32?|Type-specific maximal length of the content of the note
[MultipleNotes](UI.xml#L1597)|Boolean|Whether the type allows multiple notes for one object

<a name="ImportanceType"></a>
## [ImportanceType](UI.xml#L1605)


Member|Value|Description
:-----|----:|:----------
[High](UI.xml#L1606)|0|High importance
[Medium](UI.xml#L1609)|1|Medium importance
[Low](UI.xml#L1612)|2|Low importance

<a name="DataFieldAbstract"></a>
## [*DataFieldAbstract*](UI.xml#L1680)
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1696)|String?|A short, human-readable text suitable for labels and captions in UIs
[Criticality](UI.xml#L1700)|[CriticalityType?](#CriticalityType)|Criticality of the data field value
[CriticalityRepresentation](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[IconUrl](UI.xml#L1706)|URL?|Optional icon
...
## [CriticalityRepresentationType](UI.xml#L1712)


Member|Value|Description
:-----|----:|:----------
[WithIcon](UI.xml#L1713)|0|Criticality is represented with an icon
[WithoutIcon](UI.xml#L1716)|1|Criticality is represented without icon, e.g. only via text color
[OnlyIcon](UI.xml#L1719) *([Experimental](Common.md#Experimental))*|2|Criticality is represented only by using an icon

<a name="DataFieldForAnnotation"></a>
## [DataFieldForAnnotation](UI.xml#L1725): [DataFieldAbstract](#DataFieldAbstract)
...
## [*DataFieldForActionAbstract*](UI.xml#L1742): [DataFieldAbstract](#DataFieldAbstract)
Triggers an action
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Inline](UI.xml#L1744)|Boolean|Action should be placed close to (or even inside) the visualized term
[Determining](UI.xml#L1747)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
...
## [DataFieldForAction](UI.xml#L1752): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1744)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1747)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[Action](UI.xml#L1755)|[ActionName](#ActionName)|Name of an Action, Function, ActionImport, or FunctionImport in scope
[InvocationGrouping](UI.xml#L1758)|[OperationGroupingType?](#OperationGroupingType)|Expresses how invocations of this action on multiple instances should be grouped
...
## [OperationGroupingType](UI.xml#L1762)


Member|Value|Description
:-----|----:|:----------
[Isolated](UI.xml#L1763)|0|Invoke each action in isolation from other actions
[ChangeSet](UI.xml#L1766)|1|Group all actions into a single change set

<a name="DataFieldForIntentBasedNavigation"></a>
## [DataFieldForIntentBasedNavigation](UI.xml#L1771): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1744)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1747)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[SemanticObject](UI.xml#L1778)|String|Name of the Semantic Object
[Action](UI.xml#L1781)|String?|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
[NavigationAvailable](UI.xml#L1784)|Boolean|The navigation intent is for that user with the selected context and parameters available
[RequiresContext](UI.xml#L1787)|Boolean|Determines whether a context needs to be passed to the target of this navigation.
[Mapping](UI.xml#L1790)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object
...
## [DataFieldForActionGroup](UI.xml#L1795): [DataFieldAbstract](#DataFieldAbstract) *([Experimental](Common.md#Experimental))*
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Actions](UI.xml#L1798)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Collection of data fields that refer to actions or intent based navigations
...
<a name="DataField"></a>
## [DataField](UI.xml#L1803): [DataFieldAbstract](#DataFieldAbstract)
A piece of data
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1805)|Untyped|The data field's value
...
## [DataFieldWithAction](UI.xml#L1832): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1835)|PrimitiveType|The data field's value
[Action](UI.xml#L1836)|[ActionName](#ActionName)|Name of an Action, Function, ActionImport, or FunctionImport in scope
...
## [DataFieldWithIntentBasedNavigation](UI.xml#L1841): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1849)|PrimitiveType|The data field's value
[SemanticObject](UI.xml#L1850)|String|Name of the Semantic Object
[Action](UI.xml#L1853)|String?|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
[Mapping](UI.xml#L1856)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object
...
## [DataFieldWithNavigationPath](UI.xml#L1861): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1864)|PrimitiveType|The data field's value
[Target](UI.xml#L1865)|NavigationPropertyPath|Contains either a navigation property or a term cast, where term is of type Edm.EntityType or a concrete entity type or a collection of these types
...
## [DataFieldWithUrl](UI.xml#L1872): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1875)|PrimitiveType|The data field's value
[Url](UI.xml#L1876)|URL|Target of the hyperlink<br>Can be annotated with:<ul><li>[LinkTarget](HTML5.md#LinkTarget)</li></ul>
[UrlContentType](UI.xml#L1885)|MediaType?|Media type of the hyperlink target, e.g. `video/mp4`
...
## [DataFieldWithActionGroup](UI.xml#L1891): [DataField](#DataField) *([Experimental](Common.md#Experimental))*
Collection of OData actions and intent based navigations
...
[*CriticalityRepresentation*](UI.xml#L1703)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1706)|URL?|Optional icon
[Value](UI.xml#L1894)|PrimitiveType|The data field's value
[Actions](UI.xml#L1895)|\[[DataField](#DataField)\]|Collection of data fields that are either [DataFieldWithAction](#DataFieldWithAction), [DataFieldWithIntentBasedNavigation](#DataFieldWithIntentBasedNavigation), [DataFieldWithNavigationPath](#DataFieldWithNavigationPath), or [DataFieldWithUrl](#DataFieldWithUrl)
...
## [RecommendationStateType](UI.xml#L1933)
**Type:** Byte
...
:------------|:----------
[0](UI.xml#L1940)|regular - with human or default input, no recommendation
[1](UI.xml#L1944)|highlighted - without human input and with recommendation
[2](UI.xml#L1948)|warning - with human or default input and with recommendation

<a name="RecommendationListType"></a>
## [RecommendationListType](UI.xml#L1963)
...
Property|Type|Description
:-------|:---|:----------
[CollectionPath](UI.xml#L1968)|String|Resource path of a collection of recommended values
[RankProperty](UI.xml#L1971)|String|Name of the property within the collection of recommended values that describes the rank of the recommendation
[Binding](UI.xml#L1974)|\[[RecommendationBinding](#RecommendationBinding)\]|List of pairs of a local property and recommended value property

<a name="RecommendationBinding"></a>
## [RecommendationBinding](UI.xml#L1979)


Property|Type|Description
:-------|:---|:----------
[LocalDataProperty](UI.xml#L1980)|PropertyPath|Path to editable property for which recommended values exist
[ValueListProperty](UI.xml#L1983)|String|Path to property in the collection of recommended values. Format is identical to PropertyPath annotations.
