...
[Chart](UI.xml#L754)|[ChartDefinitionType](#ChartDefinitionType)|<a name="Chart"></a>Visualization of multiple data points
...
[ExcludeFromNavigationContext](UI.xml#L2028)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="ExcludeFromNavigationContext"></a>The contents of this property must not be propagated to the app-to-app navigation context
[DoNotCheckScaleOfMeasuredQuantity](UI.xml#L2032) *([Experimental](Common.md#Experimental))*|Boolean|<a name="DoNotCheckScaleOfMeasuredQuantity"></a>Do not check the number of fractional digits of the annotated measured quantity<br>The annotated property contains a measured quantity, and the user may enter more fractional digits than defined for the corresponding unit of measure.<br/>This switches off the validation of user input with respect to decimals.
[LeadingEntitySet](UI.xml#L2042) *([Experimental](Common.md#Experimental))*|String|<a name="LeadingEntitySet"></a>The referenced entity set is the preferred starting point for UIs using this service
...
[Columns](UI.xml#L718)|\[[ReferenceFacet](#ReferenceFacet)\]|Columns of the grid<br>Each facet must reference one of Exactly one facet targeting `FieldGroupMeasures` must occur in `Columns` and `Rows` together. At most one facet targeting `Structure` may occur in `Columns` and `Rows` together.<br>Allowed terms:<ul><li>[FieldGroupDimensions](#FieldGroupDimensions)</li><li>[FieldGroupMeasures](#FieldGroupMeasures)</li><li>[Structure](Analytics.md#Structure)</li></ul>
[Rows](UI.xml#L733)|\[[ReferenceFacet](#ReferenceFacet)\]|Rows of the grid<br>Allowed terms:<ul><li>[FieldGroupDimensions](#FieldGroupDimensions)</li><li>[FieldGroupMeasures](#FieldGroupMeasures)</li><li>[Structure](Analytics.md#Structure)</li></ul>
[Actions](UI.xml#L743)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Available actions

<a name="FieldGroupDimensions"></a>
## [FieldGroupDimensions](UI.xml#L747): [FieldGroupType](#FieldGroupType)
Field group whose `Data` consists of [`DataField`](#DataField)s whose `Value` occurs in [`Analytics.AnalyticalContext/Dimensions`](Analytics.md#AnalyticalContextType)
...
Field group whose `Data` consists of [`DataField`](#DataField)s whose `Value` occurs in [`Analytics.AnalyticalContext/Measures`](Analytics.md#AnalyticalContextType)
...
## [ChartDefinitionType](UI.xml#L758)


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L759)|String?|Title of the chart
[Description](UI.xml#L763)|String?|Short description
[ChartType](UI.xml#L767)|[ChartType](#ChartType)|Chart type
[AxisScaling](UI.xml#L770)|[ChartAxisScalingType?](#ChartAxisScalingType)|Describes the scale of the chart value axes
[Measures](UI.xml#L773)|\[PropertyPath\]|Measures of the chart, e.g. size and color in a bubble chart
[DynamicMeasures](UI.xml#L777)|\[AnnotationPath\]|Dynamic properties introduced by annotations and used as measures of the chart<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[MeasureAttributes](UI.xml#L790)|\[[ChartMeasureAttributeType](#ChartMeasureAttributeType)\]|Describes Attributes for Measures. All Measures used in this collection must also be part of the Measures Property.
[Dimensions](UI.xml#L795)|\[PropertyPath\]|Dimensions of the chart, e.g. x- and y-axis of a bubble chart
[DimensionAttributes](UI.xml#L798)|\[[ChartDimensionAttributeType](#ChartDimensionAttributeType)\]|Describes Attributes for Dimensions. All Dimensions used in this collection must also be part of the Dimensions Property.
[Actions](UI.xml#L803)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Available actions

<a name="ChartType"></a>
## [ChartType](UI.xml#L808)


Member|Value|Description
:-----|----:|:----------
[Column](UI.xml#L809)|0|
[ColumnStacked](UI.xml#L810)|1|
[ColumnDual](UI.xml#L811)|2|
[ColumnStackedDual](UI.xml#L812)|3|
[ColumnStacked100](UI.xml#L813)|4|
[ColumnStackedDual100](UI.xml#L814)|5|
[Bar](UI.xml#L815)|6|
[BarStacked](UI.xml#L816)|7|
[BarDual](UI.xml#L817)|8|
[BarStackedDual](UI.xml#L818)|9|
[BarStacked100](UI.xml#L819)|10|
[BarStackedDual100](UI.xml#L820)|11|
[Area](UI.xml#L821)|12|
[AreaStacked](UI.xml#L822)|13|
[AreaStacked100](UI.xml#L823)|14|
[HorizontalArea](UI.xml#L824)|15|
[HorizontalAreaStacked](UI.xml#L825)|16|
[HorizontalAreaStacked100](UI.xml#L826)|17|
[Line](UI.xml#L827)|18|
[LineDual](UI.xml#L828)|19|
[Combination](UI.xml#L829)|20|
[CombinationStacked](UI.xml#L830)|21|
[CombinationDual](UI.xml#L831)|22|
[CombinationStackedDual](UI.xml#L832)|23|
[HorizontalCombinationStacked](UI.xml#L833)|24|
[Pie](UI.xml#L834)|25|
[Donut](UI.xml#L835)|26|
[Scatter](UI.xml#L836)|27|
[Bubble](UI.xml#L837)|28|
[Radar](UI.xml#L838)|29|
[HeatMap](UI.xml#L839)|30|
[TreeMap](UI.xml#L840)|31|
[Waterfall](UI.xml#L841)|32|
[Bullet](UI.xml#L842)|33|
[VerticalBullet](UI.xml#L843)|34|
[HorizontalWaterfall](UI.xml#L844)|35|
[HorizontalCombinationDual](UI.xml#L845)|36|
[HorizontalCombinationStackedDual](UI.xml#L846)|37|
[Donut100](UI.xml#L847) *([Experimental](Common.md#Experimental))*|38|

<a name="ChartAxisScalingType"></a>
## [ChartAxisScalingType](UI.xml#L853)


Property|Type|Description
:-------|:---|:----------
[ScaleBehavior](UI.xml#L854)|[ChartAxisScaleBehaviorType](#ChartAxisScaleBehaviorType)|Scale is fixed or adapts automatically to rendered values
[AutoScaleBehavior](UI.xml#L857)|[ChartAxisAutoScaleBehaviorType?](#ChartAxisAutoScaleBehaviorType)|Settings for automatic scaling
[FixedScaleMultipleStackedMeasuresBoundaryValues](UI.xml#L860)|[FixedScaleMultipleStackedMeasuresBoundaryValuesType?](#FixedScaleMultipleStackedMeasuresBoundaryValuesType)|Boundary values for fixed scaling of a stacking chart type with multiple measures

<a name="ChartAxisScaleBehaviorType"></a>
## [ChartAxisScaleBehaviorType](UI.xml#L865)


Member|Value|Description
:-----|----:|:----------
[AutoScale](UI.xml#L866)|0|Value axes scale automatically
[FixedScale](UI.xml#L869)|1|Fixed minimum and maximum values are applied, which are derived from the @UI.MeasureAttributes.DataPoint/MinimumValue and .../MaximumValue annotation by default. For stacking chart types with multiple measures, they are taken from ChartAxisScalingType/FixedScaleMultipleStackedMeasuresBoundaryValues.

<a name="ChartAxisAutoScaleBehaviorType"></a>
## [ChartAxisAutoScaleBehaviorType](UI.xml#L878)


Property|Type|Description
:-------|:---|:----------
[ZeroAlwaysVisible](UI.xml#L879)|Boolean|Forces the value axis to always display the zero value
[DataScope](UI.xml#L882)|[ChartAxisAutoScaleDataScopeType](#ChartAxisAutoScaleDataScopeType)|Determines the automatic scaling

<a name="ChartAxisAutoScaleDataScopeType"></a>
## [ChartAxisAutoScaleDataScopeType](UI.xml#L887)


Member|Value|Description
:-----|----:|:----------
[DataSet](UI.xml#L888)|0|Minimum and maximum axes values are determined from the entire data set
[VisibleData](UI.xml#L891)|1|Minimum and maximum axes values are determined from the currently visible data. Scrolling will change the scale.

<a name="FixedScaleMultipleStackedMeasuresBoundaryValuesType"></a>
## [FixedScaleMultipleStackedMeasuresBoundaryValuesType](UI.xml#L896)


Property|Type|Description
:-------|:---|:----------
[MinimumValue](UI.xml#L897)|Decimal|Minimum value on value axes
[MaximumValue](UI.xml#L900)|Decimal|Maximum value on value axes

<a name="ChartDimensionAttributeType"></a>
## [ChartDimensionAttributeType](UI.xml#L905)


Property|Type|Description
:-------|:---|:----------
[Dimension](UI.xml#L906)|PropertyPath?|
[Role](UI.xml#L907)|[ChartDimensionRoleType?](#ChartDimensionRoleType)|
[HierarchyLevel](UI.xml#L908) *([Experimental](Common.md#Experimental))*|Int32?|For a dimension with a hierarchy, members are selected from this level. The root node of the hierarchy is at level 0.
[ValuesForSequentialColorLevels](UI.xml#L912) *([Experimental](Common.md#Experimental))*|\[String\]|All values in this collection should be assigned to levels of the same color.
[EmphasizedValues](UI.xml#L916) *([Experimental](Common.md#Experimental))*|\[String\]|All values in this collection should be emphasized.
[EmphasisLabels](UI.xml#L920) *([Experimental](Common.md#Experimental))*|[EmphasisLabelType?](#EmphasisLabelType)|Assign a label to values with an emphasized representation. This is required, if more than one emphasized value has been specified.

<a name="ChartMeasureAttributeType"></a>
## [ChartMeasureAttributeType](UI.xml#L926)
Exactly one of `Measure` and `DynamicMeasure` must be present

Property|Type|Description
:-------|:---|:----------
[Measure](UI.xml#L928)|PropertyPath?|
[DynamicMeasure](UI.xml#L931)|AnnotationPath?|Dynamic property introduced by an annotation and used as a measure in a chart<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[Role](UI.xml#L944)|[ChartMeasureRoleType?](#ChartMeasureRoleType)|
[DataPoint](UI.xml#L945)|AnnotationPath?|Annotation path MUST end in @UI.DataPoint and the data point's Value MUST be the same property as in Measure<br>Allowed terms:<ul><li>[DataPoint](#DataPoint)</li></ul>
...
## [ChartDimensionRoleType](UI.xml#L959)
...
## [ChartMeasureRoleType](UI.xml#L965)
...
## [EmphasisLabelType](UI.xml#L971) *([Experimental](Common.md#Experimental))*
...
## [ValueCriticalityType](UI.xml#L982) *([Experimental](Common.md#Experimental))*
...
## [CriticalityLabelType](UI.xml#L1002) *([Experimental](Common.md#Experimental))*
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1047)|String?|Facet label
[ID](UI.xml#L1051)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
...
## [CollectionFacet](UI.xml#L1055): [Facet](#Facet)
...
[*Label*](UI.xml#L1047)|String?|Facet label
[*ID*](UI.xml#L1051)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
[Facets](UI.xml#L1057)|\[[Facet](#Facet)\]|Nested facets. An empty collection may be used as a placeholder for content added via extension points.
...
## [ReferenceFacet](UI.xml#L1061): [Facet](#Facet)
...
## [ReferenceURLFacet](UI.xml#L1091): [Facet](#Facet)
...
[*Label*](UI.xml#L1047)|String?|Facet label
[*ID*](UI.xml#L1051)|String?|Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.
[Url](UI.xml#L1093)|URL|URL of referenced information<br>Can be annotated with:<ul><li>[LinkTarget](HTML5.md#LinkTarget)</li></ul>
[UrlContentType](UI.xml#L1102)|MediaType?|Media type of referenced information
...
## [SelectionPresentationVariantType](UI.xml#L1115)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1116)|String?|Optional identifier to reference this variant from an external context
[Text](UI.xml#L1121)|String?|Name of the bundling variant
[SelectionVariant](UI.xml#L1125)|[SelectionVariantType](#SelectionVariantType)|Selection variant, either specified inline or referencing another annotation via Path
[PresentationVariant](UI.xml#L1128)|[PresentationVariantType](#PresentationVariantType)|Presentation variant, either specified inline or referencing another annotation via Path

<a name="PresentationVariantType"></a>
## [PresentationVariantType](UI.xml#L1139)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1140)|String?|Optional identifier to reference this variant from an external context
[Text](UI.xml#L1143)|String?|Name of the presentation variant
[MaxItems](UI.xml#L1147)|Int32?|Maximum number of items that should be included in the result
[SortOrder](UI.xml#L1150)|\[[SortOrderType](Common.md#SortOrderType)\]|Collection can be provided inline or as a reference to a Common.SortOrder annotation via Path
[GroupBy](UI.xml#L1153)|\[PropertyPath\]|Sequence of groupable properties p1, p2, ... defining how the result is composed of instances representing groups, one for each combination of value properties in the queried collection. The sequence specifies a certain level of aggregation for the queried collection, and every group instance will provide aggregated values for properties that are aggregatable. Moreover, the series of sub-sequences (p1), (p1, p2), ... forms a leveled hierarchy, which may become relevant in combination with `InitialExpansionLevel`.
[TotalBy](UI.xml#L1162)|\[PropertyPath\]|Sub-sequence q1, q2, ... of properties p1, p2, ... specified in GroupBy. With this, additional levels of aggregation are requested in addition to the most granular level defined by GroupBy: Every element in the series of sub-sequences (q1), (q1, q2), ... introduces an additional aggregation level included in the result.
[Total](UI.xml#L1169)|\[PropertyPath\]|Aggregatable properties for which aggregated values should be provided for the additional aggregation levels specified in TotalBy.
[DynamicTotal](UI.xml#L1175)|\[AnnotationPath\]|Dynamic properties introduced by annotations for which aggregated values should be provided for the additional aggregation levels specified in TotalBy<br>If the annotation referenced by an annotation path does not apply to the same collection of entities as the one being presented according to the `UI.PresentationVariant` annotation, the annotation path MUST be silently ignored.<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[IncludeGrandTotal](UI.xml#L1188)|Boolean|Result should include a grand total for the properties specified in Total
[InitialExpansionLevel](UI.xml#L1191)|Int32|Level up to which the hierarchy defined for the queried collection should be expanded initially. The hierarchy may be implicitly imposed by the sequence of the GroupBy, or by an explicit hierarchy annotation.
[Visualizations](UI.xml#L1197)|\[AnnotationPath\]|Lists available visualization types. Currently supported types are `UI.LineItem`, `UI.Chart`, and `UI.DataPoint`. For each type, no more than a single annotation is meaningful. Multiple instances of the same visualization type shall be modeled with different presentation variants. A reference to `UI.Lineitem` should always be part of the collection (least common denominator for renderers). The first entry of the collection is the default visualization.<br>Allowed terms:<ul><li>[Chart](#Chart)</li><li>[DataPoint](#DataPoint)</li><li>[LineItem](#LineItem)</li></ul>
[RecursiveHierarchyQualifier](UI.xml#L1214) *([Experimental](Common.md#Experimental))*|[HierarchyQualifier?](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#HierarchyQualifier)|Qualifier of the recursive hierarchy that should be applied to the Visualization
[RequestAtLeast](UI.xml#L1218)|\[PropertyPath\]|Properties that should always be included in the result of the queried collection<br>Properties in `RequestAtLeast` must occur either in the `$select` clause of an OData request or among the grouping properties in an `$apply=groupby((grouping properties),...)` clause of an aggregating OData request.
[SelectionFields](UI.xml#L1241) *([Experimental](Common.md#Experimental))*|\[PropertyPath\]|Properties that should be presented for filtering a collection of entities. Can be provided inline or as a reference to a `UI.SelectionFields` annotation via Path.

<a name="SelectionVariantType"></a>
## [SelectionVariantType](UI.xml#L1255)


Property|Type|Description
:-------|:---|:----------
[ID](UI.xml#L1256)|String?|May contain identifier to reference this instance from an external context
[Text](UI.xml#L1261)|String?|Name of the selection variant
[Parameters](UI.xml#L1265)|\[[ParameterAbstract](#ParameterAbstract)\]|Parameters of the selection variant
[FilterExpression](UI.xml#L1268)|String?|Filter string for query part of URL, without `$filter=`
[SelectOptions](UI.xml#L1273)|\[[SelectOptionType](#SelectOptionType)\]|ABAP Select Options Pattern

<a name="ParameterAbstract"></a>
## [*ParameterAbstract*](UI.xml#L1280)
...
<a name="Parameter"></a>
## [Parameter](UI.xml#L1283): [ParameterAbstract](#ParameterAbstract)
Single-valued parameter

Property|Type|Description
:-------|:---|:----------
[PropertyName](UI.xml#L1285)|PropertyPath|Path to a key property of a parameter entity type
[PropertyValue](UI.xml#L1288)|PrimitiveType|Value for the key property

<a name="IntervalParameter"></a>
## [IntervalParameter](UI.xml#L1292): [ParameterAbstract](#ParameterAbstract)
Interval parameter formed with a 'from' and a 'to' property

Property|Type|Description
:-------|:---|:----------
[PropertyNameFrom](UI.xml#L1294)|PropertyPath|Path to the 'from' property of a parameter entity type
[PropertyValueFrom](UI.xml#L1297)|PrimitiveType|Value for the 'from' property
[PropertyNameTo](UI.xml#L1300)|PropertyPath|Path to the 'to' property of a parameter entity type
[PropertyValueTo](UI.xml#L1303)|PrimitiveType|Value for the 'to' property

<a name="SelectOptionType"></a>
## [SelectOptionType](UI.xml#L1308)
...
Property|Type|Description
:-------|:---|:----------
[PropertyName](UI.xml#L1311)|PropertyPath?|Path to the property
[DynamicPropertyName](UI.xml#L1323)|AnnotationPath?|Dynamic property introduced by annotations for which value ranges are specified<br>If the annotation referenced by the annotation path does not apply to the same collection of entities as the one being filtered according to the `UI.SelectionVariant` annotation, this instance of `UI.SelectionVariant/SelectOptions` MUST be silently ignored. For an example, see the `UI.SelectionVariant` annotation in the [example](../examples/DynamicProperties-sample.xml).<br>Allowed terms:<ul><li>[AggregatedProperty](Analytics.md#AggregatedProperty)</li><li>[CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)</li></ul>
[Ranges](UI.xml#L1337)|\[[SelectionRangeType](#SelectionRangeType)\]|List of value ranges

<a name="SelectionRangeType"></a>
## [SelectionRangeType](UI.xml#L1342)
Value range. If the range option only requires a single value, the value must be in the property Low

Property|Type|Description
:-------|:---|:----------
[Sign](UI.xml#L1346)|[SelectionRangeSignType](#SelectionRangeSignType)|Include or exclude values
[Option](UI.xml#L1349)|[SelectionRangeOptionType](#SelectionRangeOptionType)|Comparison operator
[Low](UI.xml#L1352)|PrimitiveType|Single value or lower interval boundary
[High](UI.xml#L1355)|PrimitiveType?|Upper interval boundary

<a name="SelectionRangeSignType"></a>
## [SelectionRangeSignType](UI.xml#L1360)


Member|Value|Description
:-----|----:|:----------
[I](UI.xml#L1361)|0|Inclusive
[E](UI.xml#L1364)|1|Exclusive

<a name="SelectionRangeOptionType"></a>
## [SelectionRangeOptionType](UI.xml#L1369)
Comparison operator

Member|Value|Description
:-----|----:|:----------
[EQ](UI.xml#L1371)|0|Equal to
[BT](UI.xml#L1374)|1|Between
[CP](UI.xml#L1377)|2|Contains pattern
[LE](UI.xml#L1380)|3|Less than or equal to
[GE](UI.xml#L1383)|4|Greater than or equal to
[NE](UI.xml#L1386)|5|Not equal to
[NB](UI.xml#L1389)|6|Not between
[NP](UI.xml#L1392)|7|Does not contain pattern
[GT](UI.xml#L1395)|8|Greater than
[LT](UI.xml#L1398)|9|Less than

<a name="InputMaskType"></a>
## [InputMaskType](UI.xml#L1466) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Mask](UI.xml#L1468)|String|The mask to be applied to the property or the parameter
[PlaceholderSymbol](UI.xml#L1471)|String|A single character symbol to be shown where the user can type a character
[Rules](UI.xml#L1474)|\[[InputMaskRuleType](#InputMaskRuleType)\]|Rules that define valid values for one symbol in the mask<br>The following rules are defined as default and don't need to be listed here: * = ., C = [a-zA-Z], 9 = [0-9]

<a name="InputMaskRuleType"></a>
## [InputMaskRuleType](UI.xml#L1481) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[MaskSymbol](UI.xml#L1483)|String|A symbol in the mask that stands for a regular expression which must be matched by the user input in every position where this symbol occurs
[RegExp](UI.xml#L1486)|String|Regular expression that defines the valid values for the mask symbol

<a name="TextArrangementType"></a>
## [TextArrangementType](UI.xml#L1499)


Member|Value|Description
:-----|----:|:----------
[TextFirst](UI.xml#L1500)|0|Text is first, followed by the code/ID (e.g. in parentheses)
[TextLast](UI.xml#L1503)|1|Code/ID is first, followed by the text (e.g. separated by a dash)
[TextSeparate](UI.xml#L1506)|2|Code/ID and text are represented separately (code/ID will be shown and text can be visualized in a separate place)
[TextOnly](UI.xml#L1509)|3|Only text is represented, code/ID is hidden (e.g. for UUIDs)

<a name="NoteType"></a>
## [NoteType](UI.xml#L1555) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Title](UI.xml#L1557)|String?|Title of the note<br>The title of a note is hidden with an annotation `@UI.Note/Title/@UI.Hidden`, not with an annotation on the property targeted by `@UI.Note/Title`.<br>Can be annotated with:<ul><li>[Hidden](#Hidden)</li></ul>
[Content](UI.xml#L1569)|String|Content of the note, as a string<br>The property targeted by `@UI.Note/Content` must be annotated with `Core.MediaType` and may be annotated with `Common.SAPObjectNodeTypeReference`. When it is tagged with `Core.IsLanguageDependent`, another property of the same entity type that is tagged with [`Common.IsLanguageIdentifier`](Common.md#IsLanguageIdentifier) determines the language of the note.<br>Can be annotated with:<ul><li>[MediaType](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#MediaType)</li><li>[IsLanguageDependent](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#IsLanguageDependent)</li><li>[SAPObjectNodeTypeReference](Common.md#SAPObjectNodeTypeReference)</li></ul>
[Type](UI.xml#L1585)|String|A type used for grouping notes
[MaximalLength](UI.xml#L1588)|Int32?|Type-specific maximal length of the content of the note
[MultipleNotes](UI.xml#L1591)|Boolean|Whether the type allows multiple notes for one object

<a name="ImportanceType"></a>
## [ImportanceType](UI.xml#L1599)


Member|Value|Description
:-----|----:|:----------
[High](UI.xml#L1600)|0|High importance
[Medium](UI.xml#L1603)|1|Medium importance
[Low](UI.xml#L1606)|2|Low importance

<a name="DataFieldAbstract"></a>
## [*DataFieldAbstract*](UI.xml#L1674)
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1690)|String?|A short, human-readable text suitable for labels and captions in UIs
[Criticality](UI.xml#L1694)|[CriticalityType?](#CriticalityType)|Criticality of the data field value
[CriticalityRepresentation](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[IconUrl](UI.xml#L1700)|URL?|Optional icon
...
## [CriticalityRepresentationType](UI.xml#L1706)


Member|Value|Description
:-----|----:|:----------
[WithIcon](UI.xml#L1707)|0|Criticality is represented with an icon
[WithoutIcon](UI.xml#L1710)|1|Criticality is represented without icon, e.g. only via text color
[OnlyIcon](UI.xml#L1713) *([Experimental](Common.md#Experimental))*|2|Criticality is represented only by using an icon

<a name="DataFieldForAnnotation"></a>
## [DataFieldForAnnotation](UI.xml#L1719): [DataFieldAbstract](#DataFieldAbstract)
...
## [*DataFieldForActionAbstract*](UI.xml#L1736): [DataFieldAbstract](#DataFieldAbstract)
Triggers an action
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Inline](UI.xml#L1738)|Boolean|Action should be placed close to (or even inside) the visualized term
[Determining](UI.xml#L1741)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
...
## [DataFieldForAction](UI.xml#L1746): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1738)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1741)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[Action](UI.xml#L1749)|[ActionName](#ActionName)|Name of an Action, Function, ActionImport, or FunctionImport in scope
[InvocationGrouping](UI.xml#L1752)|[OperationGroupingType?](#OperationGroupingType)|Expresses how invocations of this action on multiple instances should be grouped
...
## [OperationGroupingType](UI.xml#L1756)


Member|Value|Description
:-----|----:|:----------
[Isolated](UI.xml#L1757)|0|Invoke each action in isolation from other actions
[ChangeSet](UI.xml#L1760)|1|Group all actions into a single change set

<a name="DataFieldForIntentBasedNavigation"></a>
## [DataFieldForIntentBasedNavigation](UI.xml#L1765): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1738)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1741)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[SemanticObject](UI.xml#L1772)|String|Name of the Semantic Object
[Action](UI.xml#L1775)|String?|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
[NavigationAvailable](UI.xml#L1778)|Boolean|The navigation intent is for that user with the selected context and parameters available
[RequiresContext](UI.xml#L1781)|Boolean|Determines whether a context needs to be passed to the target of this navigation.
[Mapping](UI.xml#L1784)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object
...
## [DataFieldForActionGroup](UI.xml#L1789): [DataFieldAbstract](#DataFieldAbstract) *([Experimental](Common.md#Experimental))*
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Actions](UI.xml#L1792)|\[[DataFieldForActionAbstract](#DataFieldForActionAbstract)\]|Collection of data fields that refer to actions or intent based navigations
...
<a name="DataField"></a>
## [DataField](UI.xml#L1797): [DataFieldAbstract](#DataFieldAbstract)
A piece of data
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1799)|Untyped|The data field's value
...
## [DataFieldWithAction](UI.xml#L1826): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1829)|PrimitiveType|The data field's value
[Action](UI.xml#L1830)|[ActionName](#ActionName)|Name of an Action, Function, ActionImport, or FunctionImport in scope
...
## [DataFieldWithIntentBasedNavigation](UI.xml#L1835): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1843)|PrimitiveType|The data field's value
[SemanticObject](UI.xml#L1844)|String|Name of the Semantic Object
[Action](UI.xml#L1847)|String?|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
[Mapping](UI.xml#L1850)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object
...
## [DataFieldWithNavigationPath](UI.xml#L1855): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1858)|PrimitiveType|The data field's value
[Target](UI.xml#L1859)|NavigationPropertyPath|Contains either a navigation property or a term cast, where term is of type Edm.EntityType or a concrete entity type or a collection of these types
...
## [DataFieldWithUrl](UI.xml#L1866): [DataField](#DataField)
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1869)|PrimitiveType|The data field's value
[Url](UI.xml#L1870)|URL|Target of the hyperlink<br>Can be annotated with:<ul><li>[LinkTarget](HTML5.md#LinkTarget)</li></ul>
[UrlContentType](UI.xml#L1879)|MediaType?|Media type of the hyperlink target, e.g. `video/mp4`
...
## [DataFieldWithActionGroup](UI.xml#L1885): [DataField](#DataField) *([Experimental](Common.md#Experimental))*
Collection of OData actions and intent based navigations
...
[*CriticalityRepresentation*](UI.xml#L1697)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1700)|URL?|Optional icon
[Value](UI.xml#L1888)|PrimitiveType|The data field's value
[Actions](UI.xml#L1889)|\[[DataField](#DataField)\]|Collection of data fields that are either [DataFieldWithAction](#DataFieldWithAction), [DataFieldWithIntentBasedNavigation](#DataFieldWithIntentBasedNavigation), [DataFieldWithNavigationPath](#DataFieldWithNavigationPath), or [DataFieldWithUrl](#DataFieldWithUrl)
