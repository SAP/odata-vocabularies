...
Property|Type|Description
:-------|:---|:----------
[Title](./UI.xml#L1407:~:text=<ComplexType%20Name="-,NoteType,-")|String?|Title of the note<br>The title of a note is hidden with an annotation `@UI.Note/Title/@UI.Hidden`, not with an annotation of the property targeted by `@UI.Note/Title`.<br>Can be annotated with:<br>- [Hidden](#Hidden)
