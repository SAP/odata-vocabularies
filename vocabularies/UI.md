...
[TextArrangement](UI.xml#L1269)|[TextArrangementType?](#TextArrangementType)|<a name="TextArrangement"></a>Describes the arrangement of a code or ID value and its text<p>If used for a single property the [Common.Text](Common.md#Text) annotation is annotated</p>
[DisplayTimezoneOffset](UI.xml#L1288) *([Experimental](Common.md#Experimental))*|String?|<a name="DisplayTimezoneOffset"></a>Display the annotated timestamp field in this time zone<p>The display time zone is represented as an offset ±hh:mm and can be a path expression. If a path expression is used to reference a field containing the numeric offset, this offset field can in turn be annotated with [Common.Text](Common.md#Text) pointing to a third field containing the symbolic name or textual description of the display time zone.</p>
...
[OnlyIcon](UI.xml#L1388) *([Experimental](Common.md#Experimental))*|2|Criticality is represented only by using an icon
...
## <a name="DataFieldForActionAbstract"></a>[*DataFieldForActionAbstract*](UI.xml#L1411): [DataFieldAbstract](#DataFieldAbstract)
Triggers an action
...
[*CriticalityRepresentation*](UI.xml#L1372)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1375)|URL?|Optional icon
[Inline](UI.xml#L1413)|Boolean|Action should be placed close to (or even inside) the visualized term
[Determining](UI.xml#L1416)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
...
## <a name="DataFieldForAction"></a>[DataFieldForAction](UI.xml#L1421): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1413)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1416)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[Action](UI.xml#L1424)|[ActionOverload](Common.md#ActionOverload)|Qualified name of an Action, Function, ActionImport or FunctionImport in scope
...
[NavigationAvailable](UI.xml#L1453) *([Experimental](Common.md#Experimental))*|Boolean|The navigation intent is for that user with the selected context and parameters available
[RequiresContext](UI.xml#L1457)|Boolean|Determines whether a context needs to be passed to the target of this navigation.
[Mapping](UI.xml#L1460)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object
...
[*CriticalityRepresentation*](UI.xml#L1372)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[*IconUrl*](UI.xml#L1375)|URL?|Optional icon
[Value](UI.xml#L1467)|PrimitiveType|The data field's value
...
## <a name="DataFieldWithAction"></a>[DataFieldWithAction](UI.xml#L1473): [DataField](#DataField)
