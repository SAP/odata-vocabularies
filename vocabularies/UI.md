...
[Placeholder](UI.xml#L1256)|String|<a name="Placeholder"></a>A short, human-readable text that gives a hint or an example to help the user with data entry
[TextArrangement](UI.xml#L1261)|[TextArrangementType](#TextArrangementType)|<a name="TextArrangement"></a>Describes the arrangement of a code or ID value and its text<p>If used for a single property the Common.Text annotation is annotated</p>
...
[Criticality](UI.xml#L1498)|[CriticalityType](#CriticalityType)|<a name="Criticality"></a>Service-calculated criticality, alternative to UI.CriticalityCalculation
[CriticalityCalculation](UI.xml#L1502)|[CriticalityCalculationType](#CriticalityCalculationType)|<a name="CriticalityCalculation"></a>Parameters for client-calculated criticality, alternative to UI.Criticality
[OrderBy](UI.xml#L1506) *([Experimental](Common.md#Experimental))*|PropertyPath|<a name="OrderBy"></a>Sort by the referenced property instead of by the annotated property<p>Example: annotated property `SizeCode` has string values XS, S, M, L, XL, referenced property SizeOrder has numeric values -2, -1, 0, 1, 2. Numeric ordering by SizeOrder will be more understandable than lexicographic ordering by SizeCode.</p>
...
[RecommendationState](UI.xml#L1519)|[RecommendationStateType](#RecommendationStateType)|<a name="RecommendationState"></a>Indicates whether a field contains or has a recommended value<p>Intelligent systems can help users by recommending input the user may "prefer".</p>
[RecommendationList](UI.xml#L1549)|[RecommendationListType](#RecommendationListType)|<a name="RecommendationList"></a>Specifies how to get a list of recommended values for a property or parameter<p>Intelligent systems can help users by recommending input the user may "prefer".</p>
[ExcludeFromNavigationContext](UI.xml#L1581)|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/master/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="ExcludeFromNavigationContext"></a>The contents of this property must not be propagated to the app-to-app navigation context
...
## <a name="TextArrangementType"></a>[TextArrangementType](UI.xml#L1265)


Member|Value|Description
:-----|----:|:----------
[TextFirst](UI.xml#L1266)|0|Text is first, followed by the code/ID (e.g. in parentheses)
[TextLast](UI.xml#L1269)|1|Code/ID is first, followed by the text (e.g. separated by a dash)
[TextSeparate](UI.xml#L1272)|2|Code/ID and text are represented separately
[TextOnly](UI.xml#L1275)|3|Only text is represented, code/ID is hidden (e.g. for UUIDs)
...
## <a name="DataFieldForActionAbstract"></a>[*DataFieldForActionAbstract*](UI.xml#L1390): [DataFieldAbstract](#DataFieldAbstract)
Triggers an action
...
*@UI.Hidden*|[Hidden](#Hidden)|Annotation
*@UI.Importance*|[Importance](#Importance)|Annotation
[Inline](UI.xml#L1392)|Boolean|Action should be placed close to (or even inside) the visualized term
[Determining](UI.xml#L1395)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).

## <a name="DataFieldForAction"></a>[DataFieldForAction](UI.xml#L1400): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
## <a name="OperationGroupingType"></a>[OperationGroupingType](UI.xml#L1410)


Member|Value|Description
:-----|----:|:----------
[Isolated](UI.xml#L1411)|0|Invoke each action in isolation from other actions
[ChangeSet](UI.xml#L1414)|1|Group all actions into a single change set

## <a name="DataFieldForIntentBasedNavigation"></a>[DataFieldForIntentBasedNavigation](UI.xml#L1419): [DataFieldForActionAbstract](#DataFieldForActionAbstract)
...
[*Inline*](UI.xml#L1392)|Boolean|Action should be placed close to (or even inside) the visualized term
[*Determining*](UI.xml#L1395)|Boolean|Determines whether the action completes a process step (e.g. approve, reject).
[SemanticObject](UI.xml#L1426)|String|Name of the Semantic Object
[Action](UI.xml#L1429)|String|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
[RequiresContext](UI.xml#L1432)|Boolean|Determines whether a context needs to be passed to the target of this navigation.
[Mapping](UI.xml#L1435)|\[[SemanticObjectMappingType](Common.md#SemanticObjectMappingType)\]|Maps properties of the annotated entity type to properties of the Semantic Object

## <a name="DataField"></a>[DataField](UI.xml#L1440): [DataFieldAbstract](#DataFieldAbstract)
A piece of data
...
*@UI.Hidden*|[Hidden](#Hidden)|Annotation
*@UI.Importance*|[Importance](#Importance)|Annotation
[Value](UI.xml#L1442)|PrimitiveType|The data field's value

## <a name="DataFieldWithAction"></a>[DataFieldWithAction](UI.xml#L1448): [DataField](#DataField)
...
*@UI.Importance*|[Importance](#Importance)|Annotation
[*Value*](UI.xml#L1442)|PrimitiveType|The data field's value
[Action](UI.xml#L1451)|[QualifiedName](Common.md#QualifiedName)|Qualified name of an Action, Function, ActionImport or FunctionImport in scope

## <a name="DataFieldWithIntentBasedNavigation"></a>[DataFieldWithIntentBasedNavigation](UI.xml#L1456): [DataField](#DataField)
...
*@UI.Importance*|[Importance](#Importance)|Annotation
[*Value*](UI.xml#L1442)|PrimitiveType|The data field's value
[SemanticObject](UI.xml#L1464)|String|Name of the Semantic Object
[Action](UI.xml#L1467)|String|Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.
...
## <a name="DataFieldWithNavigationPath"></a>[DataFieldWithNavigationPath](UI.xml#L1475): [DataField](#DataField)
...
*@UI.Importance*|[Importance](#Importance)|Annotation
[*Value*](UI.xml#L1442)|PrimitiveType|The data field's value
[Target](UI.xml#L1478)|NavigationPropertyPath|Contains either a navigation property or a term cast, where term is of type Edm.EntityType or a concrete entity type or a collection of these types

## <a name="DataFieldWithUrl"></a>[DataFieldWithUrl](UI.xml#L1485): [DataField](#DataField)
...
*@UI.Importance*|[Importance](#Importance)|Annotation
[*Value*](UI.xml#L1442)|PrimitiveType|The data field's value
[Url](UI.xml#L1488)|URL|Target of the hyperlink
[UrlContentType](UI.xml#L1492)|MediaType|Media type of the hyperlink target, e.g. `video/mp4`

## <a name="RecommendationStateType"></a>[RecommendationStateType](UI.xml#L1526)
**Type:** Byte
...
## <a name="RecommendationListType"></a>[RecommendationListType](UI.xml#L1556)
...
Property|Type|Description
:-------|:---|:----------
[CollectionPath](UI.xml#L1561)|String|Resource path of a collection of recommended values
[RankProperty](UI.xml#L1564)|String|Name of the property within the collection of recommended values that describes the rank of the recommendation
[Binding](UI.xml#L1567)|\[[RecommendationBinding](#RecommendationBinding)\]|List of pairs of a local property and recommended value property

## <a name="RecommendationBinding"></a>[RecommendationBinding](UI.xml#L1572)


Property|Type|Description
:-------|:---|:----------
[LocalDataProperty](UI.xml#L1573)|PropertyPath|Path to editable property for which recommended values exist
[ValueListProperty](UI.xml#L1576)|String|Path to property in the collection of recommended values. Format is identical to PropertyPath annotations.
