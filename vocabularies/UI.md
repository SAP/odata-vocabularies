...
[DisplayTimeZone](UI.xml#L1604)|String|<a name="DisplayTimeZone"></a>The point in time represented by the annotated property shall be presented in the context of the given time zone<p>A value of `USER` means the current user's (i.e., their browser's) time zone.</p>
