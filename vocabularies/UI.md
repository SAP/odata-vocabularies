...
## [InputMaskType](UI.xml#L1425) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[Mask](UI.xml#L1427)|String|The mask to be applied to the property or the parameter
[PlaceholderSymbol](UI.xml#L1430)|String|A single character symbol to be shown where the user can type a character
[Rules](UI.xml#L1433)|\[[InputMaskRuleType](#InputMaskRuleType)\]|Rules that define valid values for one symbol in the mask<br>The following rules are defined as default and don't need to be listed here: * = ., C = [a-zA-Z], 9 = [0-9]

<a name="InputMaskRuleType"></a>
## [InputMaskRuleType](UI.xml#L1440) *([Experimental](Common.md#Experimental))*


Property|Type|Description
:-------|:---|:----------
[MaskSymbol](UI.xml#L1442)|String|A symbol in the mask that stands for a regular expression which must be matched by the user input in every position where this symbol occurs
[RegExp](UI.xml#L1445)|String|Regular expression that defines the valid values for the mask symbol

<a name="TextArrangementType"></a>
## [TextArrangementType](UI.xml#L1458)


Member|Value|Description
:-----|----:|:----------
[TextFirst](UI.xml#L1459)|0|Text is first, followed by the code/ID (e.g. in parentheses)
[TextLast](UI.xml#L1462)|1|Code/ID is first, followed by the text (e.g. separated by a dash)
[TextSeparate](UI.xml#L1465)|2|Code/ID and text are represented separately (code/ID will be shown and text can be visualized in a separate place)
[TextOnly](UI.xml#L1468)|3|Only text is represented, code/ID is hidden (e.g. for UUIDs)
...
Property|Type|Description
:-------|:---|:----------
[Label](UI.xml#L1649)|String?|A short, human-readable text suitable for labels and captions in UIs
[Criticality](UI.xml#L1653)|[CriticalityType?](#CriticalityType)|Criticality of the data field value
[CriticalityRepresentation](UI.xml#L1656)|[CriticalityRepresentationType?](#CriticalityRepresentationType)|Decides if criticality is visualized in addition by means of an icon
[IconUrl](UI.xml#L1659)|URL?|Optional icon
...
## [CriticalityRepresentationType](UI.xml#L1665)


Member|Value|Description
:-----|----:|:----------
[WithIcon](UI.xml#L1666)|0|Criticality is represented with an icon
[WithoutIcon](UI.xml#L1669)|1|Criticality is represented without icon, e.g. only via text color
[OnlyIcon](UI.xml#L1672) *([Experimental](Common.md#Experimental))*|2|Criticality is represented only by using an icon

<a name="DataFieldForAnnotation"></a>
## [DataFieldForAnnotation](UI.xml#L1678): [DataFieldAbstract](#DataFieldAbstract)
