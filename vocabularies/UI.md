...
[Note](./UI.xml#L1393:~:text=<Term%20Name="-,Note,-") *([Experimental](Common.md#Experimental))*|[NoteType](#NoteType)|<a name="Note"></a>The annotated entity type can be visualized in a reuse component for notes<br>Besides this annotation the reuse component also evaluates the annotations [`Core.IsMediaType`](https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Core.V1.md#IsMediaType), [`Common.IsLanguageIdentifier`](Common.md#IsLanguageIdentifier), [`Common.CreatedBy`](Common.md#CreatedBy), [`Common.CreatedAt`](Common.md#CreatedAt), [`Common.ChangedBy`](Common.md#ChangedBy), [`Common.ChangedAt`](Common.md#ChangedAt) on the same entity type and on its properties.
