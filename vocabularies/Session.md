...
:-------|:---|:----------
[NewAction](./Session.xml#L88:~:text=<ComplexType%20Name="-,StickySessionSupportedType,-")|[QualifiedName](Common.md#QualifiedName)|Bound action that initiates a sticky session for creating new entities in the targeted entity set or collection<br>Signature: - Binding parameter is collection of type of annotated entity set - No non-binding parameters - No return type <br/>If called within a sticky session the sticky session continues. <br/>Otherwise: - On success this action initiates a sticky session. - On failure no sticky session is initiated.
