...
[DraftNode](./Common.xml#L1044:~:text=<Term%20Name="-,DraftNode,-")|[DraftNodeType](#DraftNodeType)|<a name="DraftNode"></a>Entities in this set are parts of business documents that support the draft pattern
...
Property|Type|Description
:-------|:---|:----------
[*PreparationAction*](./Common.xml#L1050:~:text=<ComplexType%20Name="-,DraftNodeType,-") *(Deprecated)*|[QualifiedName?](#QualifiedName)|Preparation is always called on the draft root node
...
[PreparationAction](./Common.xml#L991:~:text=<ComplexType%20Name="-,DraftRootType,-")|[QualifiedName?](#QualifiedName)|Action that prepares a draft document for later activation
...
## <a name="DraftNodeType"></a>[DraftNodeType](./Common.xml#L1049:~:text=<ComplexType%20Name="-,DraftNodeType,-")
...
## <a name="UserID"></a>[UserID](./Common.xml#L1395:~:text=<TypeDefinition%20Name="-,UserID,-")
**Type:** String
