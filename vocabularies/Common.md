...
[AsynchronousRequestsRequired](Common.xml#L1683) *([Experimental](Common.md#Experimental))*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="AsynchronousRequestsRequired"></a>Requests to this service MUST be made with the `respond-async` preference
