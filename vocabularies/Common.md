...
[SourceEvents](./Common.xml#L1165:~:text=<ComplexType%20Name="-,SideEffectsType,-") *([Experimental](Common.md#Experimental))*|\[String\]|When the service raises one or more of these "events for side effects", the targets may be affected
...
<a name="UserID"></a>
## [UserID](./Common.xml#L1439:~:text=<TypeDefinition%20Name="-,UserID,-")
**Type:** String
