...
[NonSelectableInCollection](./Common.xml#L1479:~:text=<Term%20Name="-,NonSelectableInCollection,-") *([Experimental](Common.md#Experimental))*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="NonSelectableInCollection"></a>The annotated property has been omitted from the response because the service cannot compute this property for multiple instances at once<br>The client can obtain this property in a request that reads only one instance with this property.
