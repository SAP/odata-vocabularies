...
## [ReferentialConstraintType](Common.xml#L1659) *([Experimental](Common.md#Experimental))*
...
Property|Type|Description
:-------|:---|:----------
[Property](Common.xml#L1667)|PropertyPath|The path to the property is evaluated relative to the type containing the navigation property
[ReferencedProperty](Common.xml#L1670)|PropertyPath|The path to the referenced property MUST start with a segment containing the navigation property
