...
Property|Type|Description
:-------|:---|:----------
[SideEffectKeyBinding](./Common.xml#L1136:~:text=<ComplexType%20Name="-,SideEffectsType,-") *([Experimental](Common.md#Experimental))*|\[[SideEffectKeyBindingType](#SideEffectKeyBindingType)\]|Describes a binding between PCP fields and entity key fields
[SideEffectEventNames](./Common.xml#L1140:~:text=<ComplexType%20Name="-,SideEffectsType,-") *([Experimental](Common.md#Experimental))*|\[String\]|These events may affect the targets
...
## [SideEffectKeyBindingType](./Common.xml#L1183:~:text=<ComplexType%20Name="-,SideEffectKeyBindingType,-")


Property|Type|Description
:-------|:---|:----------
[PCPFieldName](./Common.xml#L1184:~:text=<ComplexType%20Name="-,SideEffectKeyBindingType,-") *([Experimental](Common.md#Experimental))*|String|Describes the name of a pcp field
[KeyPropertyName](./Common.xml#L1188:~:text=<ComplexType%20Name="-,SideEffectKeyBindingType,-") *([Experimental](Common.md#Experimental))*|PropertyPath|Describes the name of a key property

<a name="EffectType"></a>
## [EffectType](./Common.xml#L1193:~:text=<EnumType%20Name="-,EffectType,-") *(Deprecated)*
All side effects are essentially value changes, differentiation not needed.

<a name="SortOrderType"></a>
## [SortOrderType](./Common.xml#L1318:~:text=<ComplexType%20Name="-,SortOrderType,-")
Exactly one of `Property` and `DynamicProperty` must be present

Property|Type|Description
:-------|:---|:----------
[Property](./Common.xml#L1320:~:text=<ComplexType%20Name="-,SortOrderType,-")|PropertyPath?|Sort property
[DynamicProperty](./Common.xml#L1332:~:text=<ComplexType%20Name="-,SortOrderType,-")|AnnotationPath?|Dynamic property introduced by an annotation and used as sort property<br>If the annotation referenced by the annotation path does not apply to the same collection of entities as the one being sorted according to the [`UI.PresentationVariant`](UI.md#PresentationVariant) or `Common.SortOrder` annotation, this instance of `UI.PresentationVariant/SortOrder` or `Common.SortOrder` MUST be silently ignored.<br>Allowed terms:<br>- [AggregatedProperty](Analytics.md#AggregatedProperty)<br>- [CustomAggregate](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Aggregation.V1.md#CustomAggregate)
[Descending](./Common.xml#L1346:~:text=<ComplexType%20Name="-,SortOrderType,-")|Boolean?|Sort direction, ascending if not specified otherwise

<a name="RecursiveHierarchyType"></a>
## [RecursiveHierarchyType](./Common.xml#L1379:~:text=<ComplexType%20Name="-,RecursiveHierarchyType,-") *(Deprecated)*
...
<a name="UserID"></a>
## [UserID](./Common.xml#L1430:~:text=<TypeDefinition%20Name="-,UserID,-")
**Type:** String
