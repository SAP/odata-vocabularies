...
[ExpandAfterConcatSupported](Common.xml#L1664) *([Experimental](Common.md#Experimental))*|[Tag](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#Tag)|<a name="ExpandAfterConcatSupported"></a>Service supports `$expand` and `$select` in combination with `$apply=concat(…)`
...
[SourceEntitiesInserted](Common.xml#L1335)|\[NavigationPropertyPath\]|Creating one or more of these entities may affect the targets.
[SourceEntitiesUpdated](Common.xml#L1338)|\[NavigationPropertyPath\]|Updating one or more of these entities may affect the targets.
[SourceEntitiesDeleted](Common.xml#L1341)|\[NavigationPropertyPath\]|Deleting one or more of these entities may affect the targets.
