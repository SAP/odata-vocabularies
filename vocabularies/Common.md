...
[WebSocketBaseURL](./Common.xml#L1469:~:text=<Term%20Name="-,WebSocketBaseURL,-") *([Experimental](Common.md#Experimental))*|URL|<a name="WebSocketBaseURL"></a>Base URL for WebSocket connections
[WebSocketChannel](./Common.xml#L1474:~:text=<Term%20Name="-,WebSocketChannel,-") *([Experimental](Common.md#Experimental))*|String|<a name="WebSocketChannel"></a>Channel for WebSocket connections<br>This annotation MUST be qualified with <br>- `SideEffects` if the channel is used for side effects.
