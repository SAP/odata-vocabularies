...
[WebSocketBaseURL](Common.xml#L1495) *([Experimental](Common.md#Experimental))*|URL|<a name="WebSocketBaseURL"></a>Base URL for WebSocket connections
[StrictnessConstraint](Common.xml#L1501) *([Experimental](Common.md#Experimental))*|[ConstraintType](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Validation.V1.md#ConstraintType)|<a name="StrictnessConstraint"></a>Constraint on the payload of a request with `Prefer: handling=strict` header<br>In the absence of the `handling=strict` preference, the unmet constraint leads to a warning message but does not prevent successful execution of the request.
