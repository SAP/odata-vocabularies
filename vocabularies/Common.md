...
[WebSocketChannel](./Common.xml#L1460:~:text=<Term%20Name="-,WebSocketChannel,-") *([Experimental](Common.md#Experimental))*|String|<a name="WebSocketChannel"></a>Channel for WebSocket connections<br>This annotation MUST be qualified with <br>- `SideEffects` if the channel is used for side effects.
...
Property|Type|Description
:-------|:---|:----------
[SourceEvents](./Common.xml#L1136:~:text=<ComplexType%20Name="-,SideEffectsType,-") *([Experimental](Common.md#Experimental))*|\[String\]|These events may affect the targets
