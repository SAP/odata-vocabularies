...
## <a name="FetchValuesType"></a>[FetchValuesType](./Common.xml#L650:~:text=Name="-,FetchValuesType,-")
**Type:** Byte
...
## <a name="ValueListParameter"></a>[*ValueListParameter*](./Common.xml#L722:~:text=Name="-,ValueListParameter,-")
...
## <a name="ValueListParameterOut"></a>[ValueListParameterOut](./Common.xml#L756:~:text=Name="-,ValueListParameterOut,-"): [ValueListParameter](#ValueListParameter)
...
## <a name="ValueListParameterDisplayOnly"></a>[ValueListParameterDisplayOnly](./Common.xml#L766:~:text=Name="-,ValueListParameterDisplayOnly,-"): [ValueListParameter](#ValueListParameter)
...
## <a name="ValueListParameterFilterOnly"></a>[ValueListParameterFilterOnly](./Common.xml#L774:~:text=Name="-,ValueListParameterFilterOnly,-"): [ValueListParameter](#ValueListParameter) *(Deprecated)*
All filterable properties of the value list can be used to filter

## <a name="DraftRootType"></a>[DraftRootType](./Common.xml#L994:~:text=Name="-,DraftRootType,-"): [DraftNodeType](#DraftNodeType)
...
## <a name="QualifiedName"></a>[QualifiedName](./Common.xml#L1058:~:text=Name="-,QualifiedName,-")
**Type:** String

The QualifiedName of an OData construct in scope

## <a name="ActionOverload"></a>[ActionOverload](./Common.xml#L1062:~:text=Name="-,ActionOverload,-")
**Type:** String
...
## <a name="SideEffectsType"></a>[SideEffectsType](./Common.xml#L1079:~:text=Name="-,SideEffectsType,-")
...
## <a name="SortOrderType"></a>[SortOrderType](./Common.xml#L1256:~:text=Name="-,SortOrderType,-")
